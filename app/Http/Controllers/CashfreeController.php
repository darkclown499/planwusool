...
class CashfreeController extends Controller
{
    ...
    private function makeCashfreeApiCall($method, $endpoint, $data = null)
    {
        ...
        try {
            ...
            Log::error('Cashfree API Exception', [
    ...
    public function createPaymentSession(Request $request)
    {
        ...
        try {
            ...
            // Clean phone number - Cashfree requires 10 digits for Indian merchants
            ...
            $orderData = [
                'order_id' => $orderId,
                'order_amount' => $amount,
                'order_currency' => $credentials['currency'],
                'customer_details' => [
                ...
                'order_meta' => [
                    'return_url' => route('dashboard') . '?order_id={order_id}',
            ...
            Log::error('Cashfree Session Creation Failed: ' . $e->getMessage());
    ...
    public function verifyPayment(Request $request)
    {
        ...
        try {
            ...
            // Fetch order status using direct API call
