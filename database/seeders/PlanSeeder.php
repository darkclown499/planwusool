    ...
    public function run(): void
    {
        $plans = [
            [
                ...
                'max_warehouses' => 1,
                'themes' => ['gadgets', 'fashion', 'home-decor', 'bakery', 'supermarket', 'car-accessories', 'toy', 'perfumes', 'jewelry', 'beauty', 'pharmacy', 'books', 'sport', 'pets', 'flowers', 'coffee', 'stationery', 'spices', 'clothing', 'electronics', 'cosmetics', 'food', 'fragrances', 'home-tools', 'coffee-dates', 'jewelry-gold', 'kids', 'sports', 'stationery-books'],
