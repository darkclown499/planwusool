...
class ProductSeeder extends Seeder
{
    ...
    private function getProductsForCategory($categoryName): array
    {
        $products = [
            'عطارة وتوابل' => [
                [
                    'name' => 'زعفران فاخر 5 غرام',
                    'description' => 'زعفران أصلي بجودة ممتازة، خيوط حمراء كاملة برائحة نفاذة ومذاق لا يُقاوم.',
                    'price' => 45,
                    'sale_price' => 39,
                    'stock' => 40,
                    'cover_image' => 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'فلفل أسود مطحون طازج',
                    'description' => 'فلفل أسود يُطحن عند الطلب ليحتفظ بزيوتها العطرية ونكهته القوية.',
                    'price' => 12,
                    'stock' => 120,
                    'variants' => '[{"name": "الوزن", "values": ["100غ", "250غ", "500غ"]}]',
                    'cover_image' => 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'كمون بلدي كامل الحبة',
                    'description' => 'كمون بلدي منتقى يدوياً وحبات كاملة تعطي أطباقك نكهة شرقية أصيلة.',
                    'price' => 9,
                    'sale_price' => 7,
                    'stock' => 90,
                    'variants' => '[{"name": "الوزن", "values": ["100غ", "250غ"]}]',
                    'cover_image' => 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'خلطة بهارات المشاوي',
                    'description' => 'خلطة عطرية متوازنة من سبع بهارات مثالية لتتبيل المشاوي والدجاج.',
                    'price' => 15,
                    'stock' => 75,
                    'cover_image' => 'https://images.unsplash.com/photo-1506368249639-73a05d4f6484?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1506368249639-73a05d4f6484?w=800&h=800&fit=crop',
                ],
            ],
            'حلويات عربية' => [
                [
                    'name' => 'بقلاوة بالفستق الحلبي (كيلو)',
                    'description' => 'طبقات ورقية مقرمشة محشوة بالفستق الحلبي الفاخر ومسقيّة بقطر خفيف.',
                    'price' => 85,
                    'stock' => 30,
                    'variants' => '[{"name": "الحجم", "values": ["نصف كيلو", "كيلو", "كيلو ونصف"]}]',
                    'cover_image' => 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'كنافة نابلسية بالجبن',
                    'description' => 'كنافة نابلسية أصيلة بالجبن العكاوي الطازج تُحضَّر يومياً وتُقدَّم ساخنة.',
                    'price' => 55,
                    'sale_price' => 48,
                    'stock' => 25,
                    'cover_image' => 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'معمول بالتمر (علبة 12 حبة)',
                    'description' => 'معمول سميد محشو بمعجون التمر الفاخر ومخبوز على الطريقة التقليدية.',
                    'price' => 35,
                    'stock' => 60,
                    'cover_image' => 'https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'هريسة جوز الهند',
                    'description' => 'هريسة طرية بطبقة قشطة ذهبية ولوز محمص، قطعة تجمع بين الأصالة والذوق.',
                    'price' => 40,
                    'sale_price' => null,
                    'stock' => 0,
                    'cover_image' => 'https://images.unsplash.com/photo-1519869325930-281384150729?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1519869325930-281384150729?w=800&h=800&fit=crop',
                ],
            ],
            'أزياء وملابس' => [
                [
                    'name' => 'عباية صيفية بتطريز يدوي',
                    'description' => 'عباية خفيفة بقماش كريب مريح وتطريز يدوي أنيق يناسب المناسبات والخروج اليومي.',
                    'price' => 220,
                    'sale_price' => 180,
                    'stock' => 35,
                    'variants' => '[{"name": "المقاس", "values": ["S", "M", "L", "XL"]}]',
                    'cover_image' => 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'قميص قطني رجالي كلاسيك',
                    'description' => 'قميص قطني 100% بقصة كلاسيكية مريحة يصلح للعمل والمناسبات.',
                    'price' => 95,
                    'stock' => 50,
                    'variants' => '[{"name": "المقاس", "values": ["M", "L", "XL", "XXL"]}]',
                    'cover_image' => 'https://images.unsplash.com/photo-1488161628813-04466f872be2?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1488161628813-04466f872be2?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'فستان بناتي مطبع',
                    'description' => 'فستان قطني ناعم بطبعات مرحة لأجواء الصيف، مناسب للأعمار 2-10 سنوات.',
                    'price' => 75,
                    'sale_price' => 60,
                    'stock' => 45,
                    'cover_image' => 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'شال صوف شتوي',
                    'description' => 'شال صوف دافئ بلون هادئ يكمل إطلالتك الشتوية بأناقة.',
                    'price' => 55,
                    'stock' => 80,
                    'cover_image' => 'https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?w=800&h=800&fit=crop',
                ],
            ],
            'قهوة وأعشاب' => [
                [
                    'name' => 'قهوة عربية مطحونة بالهيل 500غ',
                    'description' => 'قهوة عربية أصيلة محمصة بدرجة متوسطة ومطحونة بالهيل الأخضر الفاخر.',
                    'price' => 40,
                    'stock' => 70,
                    'variants' => '[{"name": "الحجم", "values": ["250غ", "500غ", "1كيلو"]}]',
                    'cover_image' => 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'قهوة مختصة إثيوبية',
                    'description' => 'حبوب قهوة مختصة من مرتفعات إثيوبيا بنوتات فواكه وزهور مميزة.',
                    'price' => 65,
                    'sale_price' => 52,
                    'stock' => 30,
                ...
                [
                    'name' => 'بابونج طبيعي مجفف',
                    'description' => 'أزهار بابونج مجففة طبيعياً لمشروب مهدئ برائحة عطرية لطيفة.',
                    'price' => 18,
                    'stock' => 100,
                    'cover_image' => 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'شاي أخضر بالنعناع',
                    'description' => 'خلطة شاي أخضر بالنعناع الطازج لتحضير كوب منعش في أي وقت.',
                    'price' => 22,
                    'stock' => 85,
                    'cover_image' => 'https://images.unsplash.com/photo-1564890369478-c89ca64c80e6?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1564890369478-c89ca64c80e6?w=800&h=800&fit=crop',
                ],
            ],
            'مخبز ومعجنات' => [
                [
                    'name' => 'خبز عربي طازج (5 أرغفة)',
                    'description' => 'خبز عربي طازج يُخبز على الحجر مرتين يومياً.',
                    'price' => 8,
                    'stock' => 200,
                    'cover_image' => 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'كاك وسكر (علبة 12 حبة)',
                    'description' => 'كاك بالسكر هش ولذيذ مخبوز طازجاً كل صباح.',
                    'price' => 25,
                    'sale_price' => null,
                    'stock' => 40,
                    'cover_image' => 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'فطاير سبانخ (علبة 6 حبات)',
                    'description' => 'فطاير سبانخ بزيت الزيتون والسماق من فرن الحي.',
                    'price' => 30,
                    'stock' => 35,
                    'cover_image' => 'https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=800&h=800&fit=crop',
                ...
                [
                    'name' => 'مانيشة زعتر بلدي',
                    'description' => 'عجينة طرية مغطاة بزعتر بلدي وزيت زيتون بكر تُخبز أمامك.',
                    'price' => 12,
                    'stock' => 0,
                    'cover_image' => 'https://images.unsplash.com/photo-1628840042765-356cda07504e?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1628840042765-356cda07504e?w=800&h=800&fit=crop',
                ],
            ],
            'ألبان وأجبان' => [
                [
                    'name' => 'لبن رايب طازج (لتر)',
                    'description' => 'لبن رايب طبيعي 100% من مزارع محلية موثوقة.',
                    'price' => 9,
                    'stock' => 60,
                    'cover_image' => 'https://images.unsplash.com/photo-1488477181946-64290103bb53?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1488477181946-64290103bb53?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'جبنة عكاوي مملحة',
                    'description' => 'جبنة عكاوي بيضاء طازجة مثالية للكنافة أو الفطور مع الزيتون.',
                    'price' => 32,
                    'sale_price' => 28,
                    'stock' => 25,
                    'variants' => '[{"name": "الوزن", "values": ["500غ", "1كيلو"]}]',
                    'cover_image' => 'https://images.unsplash.com/photo-1634487359989-3e90c9432133?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1634487359989-3e90c9432133?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'لبنة بلدية (علبة)',
                    'description' => 'لبنة بلدية كريمية بقوام متماسك وطعم حامضي لطيف.',
                    'price' => 15,
                    'stock' => 45,
                    'cover_image' => 'https://images.unsplash.com/photo-1584278860047-22db9ff82bed?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1584278860047-22db9ff82bed?w=800&h=800&fit=crop',
                ],
                [
                    'name' => 'سمنة بلدية نباتية',
                    'description' => 'سمنة بلدية أصيلة تعطي الحلويات والمخبوزات نكهتها التقليدية.',
                    'price' => 28,
                    'stock' => 38,
                    'cover_image' => 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&h=800&fit=crop',
                    'images' => 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&h=800&fit=crop',
                ],
            ],
            'إكسسوارات الجوال' => [
                [
