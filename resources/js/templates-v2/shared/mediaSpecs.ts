...
export const MEDIA_SPECS: Record<string, TemplateMediaSpecs> = {
  ...
  'fashion-atelier': {
    hero: {
      desktopImage: {
        label: 'صورة البانر',
        description: 'تظهر في أعلى الصفحة — بانر محتوى بظل طافٍ.',
        desktop: { width: 1200, height: 800, ratio: '3:2', fit: 'cover' },
        formats: 'JPG / PNG / WebP',
        maxSize: 'أقل من 2MB',
        help: 'المقاس الموصى به: 1200 × 800 بكسل — نسبة 3:2',
      },
      mobileImage: {
        label: 'صورة البانر — الهاتف (اختياري)',
        description: 'إن تركتها فارغة سيتم استخدام نفس الصورة مع قص لطيف.',
        desktop: { width: 1200, height: 800, ratio: '3:2', fit: 'cover' },
        formats: 'JPG / PNG / WebP',
        maxSize: 'أقل من 2MB',
        help: 'المقاس الموصى به: 1200 × 800 بكسل — نسبة 3:2',
      ...
      desktopVideo: {
        label: 'فيديو البانر',
        description: 'يعمل بدل الصورة عند اختيار نوع فيديو.',
        desktop: { width: 1200, height: 800, ratio: '3:2', fit: 'cover' },
        formats: 'MP4 / WebM',
        maxSize: 'أقل من 8MB',
        help: 'المقاس الموصى به: 1200 × 800 بكسل — نسبة 3:2 — MP4 مُكتوم',
      },
      mobileVideo: {
        label: 'فيديو البانر — الهاتف (اختياري)',
        description: 'فارغ = يستخدم فيديو سطح المكتب.',
        desktop: { width: 1200, height: 800, ratio: '3:2', fit: 'cover' },
        formats: 'MP4 / WebM',
        maxSize: 'أقل من 8MB',
        help: 'المقاس الموصى به: 1200 × 800 بكسل — نسبة 3:2',
      ...
      desktopYoutube: {
        label: 'رابط YouTube',
        description: 'يُعرض بدل الصورة عند اختيار YouTube.',
        desktop: { width: 1200, height: 800, ratio: '3:2', fit: 'cover' },
        formats: 'YouTube URL',
        maxSize: '—',
        help: 'المقاس الموصى به: 1200 × 800 بكسل — نسبة 3:2',
      ...
      mobileYoutube: {
        label: 'رابط YouTube — الهاتف (اختياري)',
        description: 'فارغ = يستخدم رابط سطح المكتب.',
        desktop: { width: 1200, height: 800, ratio: '3:2', fit: 'cover' },
        formats: 'YouTube URL',
        maxSize: '—',
        help: 'المقاس الموصى به: 1200 × 800 بكسل — نسبة 3:2',
  ...
  'restaurant-menu': {
    hero: {
      desktopImage: {
        label: 'بانر الهيئة — سطح المكتب',
        description: 'بانر محتوى مدمج بزوايا مستديرة — سلايدر حتى 10 شرائح — ارتفاع متجاوب 360-460px.',
        desktop: { width: 1600, height: 600, ratio: '8:3', fit: 'cover' },
        formats: 'JPG / PNG / WebP',
        maxSize: 'أقل من 2MB',
        help: 'المقاس المقترح: 1600 × 600 بكسل — نسبة 8:3 — الوضع: Cover — حتى 10 شرائح',
      ...
      mobileImage: {
        label: 'بانر الهيئة — الهاتف',
        description: 'نسخة عمودية للهاتف. فارغة = تستخدم صورة سطح المكتب.',
        desktop: { width: 1080, height: 1350, ratio: '4:5', fit: 'cover' },
        formats: 'JPG / PNG / WebP',
        maxSize: 'أقل من 2MB',
        help: 'المقاس المقترح: 1080 × 1350 بكسل — نسبة 4:5 — الوضع: Cover',
      ...
      desktopVideo: {
        label: 'فيديو الهيئة — سطح المكتب',
        description: 'يظهر بدل السلايدر عند اختيار نوع فيديو.',
        desktop: { width: 1600, height: 600, ratio: '8:3', fit: 'cover' },
        formats: 'MP4 / WebM',
        maxSize: 'أقل من 8MB',
      ...
      desktopYoutube: {
        ...
        formats: 'YouTube URL',
        maxSize: '—',
        help: 'YouTube — 1600×600 — الوضع: Cover',
      },
      mobileYoutube: {
        label: 'YouTube — الهاتف',
        description: 'يوتيوب للهاتف. فارغ = سطح المكتب.',
