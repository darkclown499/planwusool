# Pharmacy Store Theme

A modern, fresh grocery store theme designed for pharmacys, grocery stores, and food retailers.

## Theme Overview

The Pharmacy theme provides a clean, professional interface optimized for grocery shopping with:
...
- **Pharmacies**: Large grocery chains
...
To use this theme, set the store's theme to `pharmacy` in the database or admin panel.