                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 ${
                          emailError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-emerald-500 focus:border-emerald-500'
                        }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 ${
                          phoneError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-emerald-500 focus:border-emerald-500'
                        }`}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-1.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
              ...
              <div className="p-4 md:p-6">
                ...
                <div className="space-y-4 mb-6">
                  {cartItems.map((item, index) => (
                    <div key={index} className="bg-emerald-50 rounded-2xl p-3 sm:p-4 border border-emerald-100">
                              ...
                              <div className="flex items-center gap-1 sm:gap-2 bg-white rounded-xl p-1">
                                <button 
                                  ...
                                  className={`w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg ${
                                    item.quantity > 1 ? 'bg-emerald-600 hover:bg-emerald-700 text-white' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                                  } transition-colors`}
                                >
                                ...
                                <button 
                                  ...
                                  className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors"
                                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className={`flex-1 px-3 sm:px-4 py-2.5 sm:py-3 border rounded-xl focus:outline-none focus:ring-2 text-sm sm:text-base ${
                        couponError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-emerald-500'
                      }`}
                    />
                    <button
                      onClick={() => handleApplyCoupon(subtotal)}
                      className="px-4 sm:px-6 py-2.5 sm:py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-medium transition-colors text-sm sm:text-base whitespace-nowrap"
                    >
                      تطبيق
                    </button>
                  </div>
                  {couponError && <p className="text-red-500 text-xs sm:text-sm mt-2">{couponError}</p>}
                  {appliedCoupon && <p className="text-emerald-600 text-xs sm:text-sm mt-2">✓ تم تطبيق الكوبون "{appliedCoupon.code}"</p>}
                </div>
                  ...
                  {loadingShipping ? (
                    ...
                    <div className="space-y-2">
                      {shippingMethods.map((method) => (
                        <label key={method.id} className="flex items-center gap-3 p-3 border rounded-xl cursor-pointer hover:bg-emerald-50">
                          <input
                            type="radio"
                            name="shipping"
                            value={method.id}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-t border-emerald-200 pt-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-xl font-bold text-emerald-600">{formatCurrency(total, storeSettings, currencies)}</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    {paymentMethods.map((method) => (
                      <div key={method.name} className={`border-2 rounded-2xl transition-all ${
                        selectedPayment === method.name ? 'border-emerald-500 bg-emerald-50' : 'border-gray-200 hover:border-gray-300'
                      }`}>
                        ...
                        {selectedPayment === method.name && method.name === 'whatsapp' && (
                          <div className="px-4 pb-4 border-t border-gray-200 mt-2 pt-4">
                            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-4 mb-4">
                              <h5 className="font-semibold text-emerald-900 mb-2">الدفع عبر واتساب</h5>
                              <div className="text-sm text-emerald-800">سيتم تحويلك إلى واتساب لإتمام عملية الدفع.</div>
                            </div>
                            <div>
                              <label className="block text-sm font-semibold text-gray-800 mb-2">
                                رقم واتساب *
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none bg-white ${
                                  whatsappError ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-emerald-500'
                                }`}
                              />
                              {whatsappError && (
          ...
          <div className="border-t bg-white p-4 md:p-6">
            ...
            <div className="md:hidden">
              <div className="text-right mb-4">
                ...
                <p className="text-2xl font-bold text-emerald-600">{formatCurrency(total, storeSettings, currencies)}</p>
              </div>
                ...
                <div className="flex-1">
                  {step < 3 ? (
                    <button
                      ...
                      className="w-full px-6 py-3 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-300 text-white font-semibold rounded-xl transition-colors disabled:cursor-not-allowed text-sm"
                    >
                      متابعة
                    </button>
                  ) : (
            ...
            <div className="hidden md:flex md:items-center md:justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-sm text-gray-600">الإجمالي</p>
                  <p className="text-xl font-bold text-emerald-600">{formatCurrency(total, storeSettings, currencies)}</p>
                </div>
                ...
                {step < 3 ? (
                  <button
                    ...
                    className="px-8 py-3 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-300 text-white font-semibold rounded-xl transition-colors disabled:cursor-not-allowed"
                  >
                    متابعة
                  </button>
                ) : (
