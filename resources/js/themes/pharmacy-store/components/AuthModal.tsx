        ...
        >
          ...
          <div className="relative p-6 md:p-8 text-center bg-gradient-to-br from-emerald-50 to-emerald-100">
            <button 
              ...
              className="absolute top-4 left-4 p-2 text-gray-600 hover:text-gray-800 hover:bg-emerald-200 rounded-full transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
          ...
          <div className="p-6 md:p-8 space-y-4">
            ...
            <button
              onClick={onLogin}
              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-4 px-6 rounded-2xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-3 group"
            >
