...
export const OrderInvoice: React.FC<OrderInvoiceProps> = ({ orderNumber, order }) => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-emerald-50 py-4 sm:py-6 md:py-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
              ...
              <div className="flex gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-700 text-white px-3 sm:px-4 py-2.5 rounded-xl transition-colors flex items-center gap-2 text-sm print:hidden"
                >
            ...
            {/* Order Status Banner */}
            <div className="bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-2xl p-4 sm:p-6 mb-6">
                  ...
                  <div key={index} className="bg-emerald-50 rounded-2xl p-4 border border-emerald-100">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div className="col-span-2 pt-2 border-t border-emerald-200">
                        ...
                        <p className="font-bold text-emerald-600 text-lg">{formatCurrency(itemTotalWithTax, storeSettings, currencies)}</p>
                      </div>
                    </div>
                  </div>
                );
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
            ...
            <div className="bg-emerald-50 rounded-2xl p-4 sm:p-6">
              <div className="space-y-3">
                ...
                {(order.discount ?? 0) > 0 && (
                  <div className="flex justify-between text-emerald-600 text-sm sm:text-base">
                ...
                <div className="border-t border-emerald-200 pt-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl sm:text-3xl font-bold text-emerald-600">{formatCurrency(order.total, storeSettings, currencies)}</span>
                  </div>
                </div>
