          ...
          <div className="flex-1 p-4 md:p-6 overflow-y-auto">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                {isLogin ? 'سجّل الدخول إلى حسابك للمتابعة' : 'انضم إلينا لبدء تجربة تسوق مريحة'}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input 
                      ...
                      required 
                      className={`w-full px-3 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 ${
              ...
              <div className="text-center">
                ...
                <button 
                  ...
                  type="button" 
                  className="text-emerald-600 hover:text-emerald-700 font-semibold mr-2 text-sm"
                >
