  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50" onClick={onClose}>
      <div className="flex items-end sm:items-center justify-center min-h-full p-0 sm:p-2 md:p-4">
        ...
        >
          {/* Modal Header */}
          <div className="flex items-center justify-between p-3 sm:p-4 border-b bg-white sm:bg-emerald-50">
            ...
            <div className="flex-1 flex flex-col md:min-h-0">
              <div className="flex-1 md:overflow-y-auto">
                <div className="p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 md:space-y-6">
                  ...
                  <div>
                    {product.category && (
                      <span className="inline-block bg-emerald-100 text-emerald-800 text-xs sm:text-sm font-medium px-2 sm:px-3 py-1 rounded-full mb-2 sm:mb-3">
                        {product.category}
                      </span>
                    )}
                  ...
                  <div className="flex items-center gap-2">
                    <div className={`w-2 h-2 rounded-full ${
                      product.availability === 'in_stock' ? 'bg-emerald-500' : 'bg-red-500'
                    }`}></div>
                    <span className={`text-sm font-medium ${
                      product.availability === 'in_stock' ? 'text-emerald-700' : 'text-red-700'
                    }`}>
