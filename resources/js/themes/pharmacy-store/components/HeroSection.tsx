      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="text-center">
          {welcomeMessage ? (
            ...
            <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-6 text-white">
              منتجات آمنة وموثوقة لصحتك وعائلتك
            </h1>
          )}
          
          {description && (
            <p className="break-all text-base md:text-lg text-emerald-100 leading-relaxed mb-8 max-w-2xl mx-auto">
              {description}
            </p>
          )}
          ...
          {fullAddress && (
            <div className="bg-white rounded-lg p-4 mx-auto max-w-md mb-4 md:mb-0">
              <h3 className="font-semibold text-emerald-700 mb-2">📍 موقع المتجر</h3>
