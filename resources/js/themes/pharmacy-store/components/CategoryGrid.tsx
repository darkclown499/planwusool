  ...
  return (
    <section className="py-3 md:py-6 bg-white sticky top-16 md:top-20 z-30">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Categories Grid */}
        <div className="flex gap-4 md:gap-6 overflow-x-auto scrollbar-thin scrollbar-thumb-emerald-300 scrollbar-track-gray-100 hover:scrollbar-thumb-emerald-400 p-2">
