        ...
        >
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-t border-emerald-200 pt-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-emerald-600">{formatCurrency(order.total, storeSettings, currencies)}</span>
                    </div>
                  </div>
          ...
          <div className="border-t border-gray-200 p-4 md:p-6 bg-white">
            <button
              ...
              className="w-full md:w-auto bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
            >
