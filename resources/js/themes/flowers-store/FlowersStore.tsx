...
const FlowersStoreContent: React.FC = () => {
          ...
          {categories.map((category) => (
            <div key={category.id} id={`category-${category.id}`} className="mb-12 md:mb-16">
              <div className="mb-8">
                ...
                <div className="w-20 h-0.5 bg-red-400 mx-auto"></div>
              </div>
              <ProductGrid
...
export const FlowersStore: React.FC<FlowersStoreProps> = (props) => {
  return (
