    ...
    <div className="fixed inset-0 z-50 overflow-hidden" onClick={onClose}>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        ...
        <div className="p-6 space-y-4">
          {/* Login Option */}
          <div className="border-2 border-gray-100 hover:border-red-200 transition-colors p-6 cursor-pointer group" onClick={onLogin}>
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-red-100 group-hover:bg-red-200 transition-colors flex items-center justify-center flex-shrink-0">
          ...
          {/* Guest Option */}
          <div className="border-2 border-gray-100 hover:border-red-200 transition-colors p-6 cursor-pointer group" onClick={onContinueAsGuest}>
            <div className="flex items-start space-x-4">
