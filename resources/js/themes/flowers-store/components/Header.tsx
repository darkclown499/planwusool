...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-white shadow-sm border-b border-red-100">
            ...
            <div className="hidden md:flex flex-1 max-w-md mx-8">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-transparent focus:bg-white transition-all"
                />
              </div>
            </div>
              ...
              {isLoggedIn ? (
                <div className="relative">
                  <button 
                    ...
                    className="flex items-center gap-1 md:gap-2 px-2 md:px-4 py-2 text-sm font-medium text-gray-700 hover:text-red-600 transition-colors"
                  >
                  ...
                  {showDropdown && (
                    <div className="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-100 py-2 z-50">
                      <button
                        ...
                        className="w-full text-right px-4 py-2 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 flex items-center gap-3"
                      >
                ...
                <button 
                  ...
                  className="px-2 md:px-4 py-2 text-sm font-medium text-gray-700 hover:text-red-600 transition-colors"
                >
        ...
        <div className="md:hidden fixed top-20 left-0 right-0 z-50 bg-white border-b border-gray-200 px-4 py-3">
          <div className="relative">
            ...
            <input
              ...
              value={searchQuery}
              onChange={handleSearchChange}
              className="w-full pl-12 pr-10 py-3 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-transparent focus:bg-white transition-all"
              autoFocus
            />
            <button 
              onClick={toggleMobileSearch}
