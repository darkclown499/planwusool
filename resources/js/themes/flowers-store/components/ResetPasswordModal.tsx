        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between p-6 border-b flex-shrink-0">
            ...
            <button 
              ...
              className="p-2 text-gray-400 hover:text-gray-600 hover:bg-red-50 rounded-full transition-colors cursor-pointer"
            >
          ...
          <div className="p-6 overflow-y-auto">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button 
                type="submit" 
                className="w-full py-2 px-4 rounded-lg font-medium transition-colors bg-red-600 hover:bg-red-700 cursor-pointer text-white"
              >
              ...
              <p className="text-center text-sm text-gray-600">
                ...
                <button 
                  onClick={onClose}
                  type="button" 
                  className="text-red-600 hover:text-red-700 font-medium mr-1 cursor-pointer"
                >
                  تسجيل الدخول
                </button>
              </p>
