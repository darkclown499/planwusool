              ...
              <div className="flex justify-center md:justify-start gap-3 mb-2">
                {socialMedia.facebook && (
                  <a
                    ...
                    className="w-8 h-8 bg-red-100 hover:bg-red-600 hover:!text-white rounded-lg flex items-center justify-center text-red-600 transition-colors focus:outline-none"
                  >
