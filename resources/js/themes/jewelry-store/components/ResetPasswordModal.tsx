  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col border border-yellow-100">
          <div className="flex items-center justify-between p-6 border-b border-yellow-100 bg-yellow-50 flex-shrink-0">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-yellow-900">إعادة تعيين كلمة المرور</h2>
            </div>
            <button 
          ...
          <div className="p-6 overflow-y-auto">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button 
                type="submit" 
                className="w-full py-3 px-4 rounded-lg font-semibold transition-colors bg-yellow-600 hover:bg-yellow-700 text-white"
              >
