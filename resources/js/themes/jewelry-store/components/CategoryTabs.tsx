...
export const CategoryTabs: React.FC<CategoryTabsProps> = ({
  ...
  return (
    <div className="sticky top-[80px] md:top-[100px] z-40 bg-white/95 backdrop-blur-md border-b border-yellow-100 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="relative">
          {/* Left Scroll Button */}
          <button
            onClick={scrollLeft}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-1.5 md:p-2 bg-white shadow-lg rounded-full border border-yellow-200 hover:bg-yellow-50 transition-colors"
          >
            <ChevronLeft className="w-4 h-4 md:w-5 md:h-5 text-yellow-700 rtl-flip" />
          </button>
              ...
              <button
                ...
                className={`
                  ...
                  ${activeCategory === category.id
                    ? 'bg-yellow-600 text-white shadow-lg transition-all duration-200'
                    : 'bg-yellow-50 text-yellow-800 hover:bg-yellow-100 hover:shadow-md transition-colors duration-200'
                  }
                `}
              >
          ...
          <button
            onClick={scrollRight}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-1.5 md:p-2 bg-white shadow-lg rounded-full border border-yellow-200 hover:bg-yellow-50 transition-colors"
          >
            <ChevronRight className="w-4 h-4 md:w-5 md:h-5 text-yellow-700 rtl-flip" />
          </button>
        </div>
