...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-yellow-900/90"></div>
        ...
        <div className="text-center">
          <div className="text-white space-y-8 max-w-4xl mx-auto">
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl font-serif font-bold leading-tight text-yellow-200">
                {storeName}
              </h1>
              
              {welcomeMessage && (
                <p className="break-all text-xl md:text-2xl text-yellow-100 font-light leading-relaxed">
                  {welcomeMessage}
                </p>
              )}
              
              {description && (
                <p className="break-all text-lg text-yellow-200/90 leading-relaxed">
                  {description}
                </p>
              )}
            </div>
            ...
            {/* Store Info */}
            {fullAddress && (
              <div className="flex items-center justify-center space-x-1 md:space-x-2 text-yellow-100">
                <MapPin className="w-4 h-4 md:w-5 md:h-5 flex-shrink-0" />
                <p className="text-sm md:text-base text-yellow-200/80">{fullAddress}</p>
              </div>
            )}
          </div>
