...
const JewelryStoreContent: React.FC = () => {
  ...
  return (
    <div data-storefront="true" dir="rtl" className="min-h-screen bg-yellow-50">
          ...
          {categories.map((category) => (
            <div key={category.id} id={`category-${category.id}`} className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-serif text-yellow-900 mb-4">
                  {category.name}
                </h2>
                <div className="w-24 h-1 bg-yellow-600 mx-auto rounded-full"></div>
                {category.description && (
                  <p className="text-yellow-700/70 mt-4 max-w-2xl mx-auto">
                    {category.description}
                  </p>
                )}
              </div>
...
export const JewelryStore: React.FC<JewelryStoreProps> = (props) => {
  return (
