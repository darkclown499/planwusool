      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border-2 border-amber-200" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="p-6 text-center border-b border-amber-100 bg-amber-50 relative">
            <button 
              onClick={onClose}
              className="absolute top-4 left-4 p-2 text-amber-600 hover:text-amber-800 hover:bg-amber-100 rounded-full transition-colors"
            ...
            <h2 className="text-2xl font-serif font-bold text-amber-900 mb-2">مستعد لإتمام الطلب؟</h2>
            <p className="text-amber-700 text-sm">اختر كيف تريد المتابعة مع طلبك</p>
          </div>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-amber-600 font-medium">أو</span>
              </div>
            </div>
