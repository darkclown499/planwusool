              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-center text-sm text-gray-600">
                  ...
                  <button 
                    ...
                    type="button" 
                    className="text-fuchsia-600 hover:text-fuchsia-700 font-medium mr-1 cursor-pointer"
                  >
                    تسجيل الدخول
                  </button>
                </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {isLogin && (
                <button 
                  ...
                  type="button" 
                  className="text-fuchsia-600 hover:text-fuchsia-700 text-sm cursor-pointer"
                >
                  نسيت كلمة المرور؟
                </button>
              )}
