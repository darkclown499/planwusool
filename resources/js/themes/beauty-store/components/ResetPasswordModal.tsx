        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between p-6 border-b flex-shrink-0">
            ...
            <button 
              ...
              className="p-2 text-gray-400 hover:text-gray-600 hover:bg-fuchsia-50 rounded-full transition-colors cursor-pointer"
            >
          ...
          <div className="p-6 overflow-y-auto">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button 
                type="submit" 
                className="w-full py-2 px-4 rounded-lg font-medium transition-colors bg-fuchsia-600 hover:bg-fuchsia-700 cursor-pointer text-white"
              >
