    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-0 md:p-4">
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
          {/* Header */}
          <div className="flex items-center justify-between p-4 md:p-6 border-b border-fuchsia-100 flex-shrink-0">
            ...
            <button onClick={onClose} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-fuchsia-50 rounded-full transition-colors cursor-pointer">
          ...
          {/* Progress Steps */}
          <div className="px-6 py-6 bg-white border-b border-fuchsia-100 flex-shrink-0">
                ...
                <div key={stepNum} className="flex items-center">
                  <div className="flex flex-col items-center md:hidden">
                    <div className={`w-10 h-10 rounded-2xl flex items-center justify-center text-sm font-bold shadow-lg transition-all duration-300 ${
                      step >= stepNum 
                        ? 'bg-fuchsia-600 text-white transform scale-110' 
                    ...
                    <span className={`mt-2 text-xs font-medium ${step >= stepNum ? 'text-fuchsia-600' : 'text-gray-400'}`}>
                  ...
                  <div className="hidden md:flex md:items-center">
                    ...
                    <span className={`mr-3 font-semibold ${step >= stepNum ? 'text-fuchsia-600' : 'text-gray-400'}`}>
                      {stepNum === 1 ? 'المعلومات' : stepNum === 2 ? 'المراجعة' : 'الدفع'}
                    </span>
                  </div>
                  ...
                  {stepNum < 3 && (
                    <div className={`w-8 md:w-20 h-1 mr-3 md:mr-6 rounded-full transition-all duration-300 ${
                      step > stepNum ? 'bg-fuchsia-600' : 'bg-gray-200'
                    }`}></div>
                  )}
                </div>
              ))}
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-300 focus:border-fuchsia-300"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-300 focus:border-fuchsia-300 ${
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger className="w-full focus:ring-fuchsia-300 focus:border-fuchsia-300">
              ...
              <div className="p-4 md:p-6">
                <div className="space-y-4 mb-6">
                  {cartItems.map((item, index) => (
                    <div key={index} className="bg-white rounded-2xl p-4 shadow-sm border border-fuchsia-100">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between mb-2">
                            <p className="text-fuchsia-600 font-bold text-lg">{formatCurrency(item.price * item.quantity, storeSettings, currencies)}</p>
                            <button 
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3 bg-fuchsia-100 rounded-lg p-1">
                              <button 
                                ...
                                className={`w-7 h-7 flex items-center justify-center rounded-md text-white text-sm shadow-sm font-bold leading-none ${
                                  item.quantity > 1 ? 'bg-fuchsia-600 hover:bg-fuchsia-700 cursor-pointer' : 'bg-gray-400 cursor-not-allowed'
                                }`}
                              >
                                −
                              </button>
                              ...
                              <button 
                                ...
                                className="w-7 h-7 flex items-center justify-center bg-fuchsia-600 hover:bg-fuchsia-700 rounded-md text-white text-sm cursor-pointer shadow-sm font-bold leading-none"
                              >
                                +
                              </button>
                            </div>
                ...
                <div className="bg-fuchsia-50 rounded-lg p-4 mb-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className={`flex-1 px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-300 focus:border-fuchsia-300 text-base bg-white ${
                        couponError ? 'border-red-500' : 'border-gray-200'
                      }`}
                    />
                    <button
                      onClick={() => handleApplyCoupon(subtotal)}
                      className="px-4 py-3 bg-fuchsia-600 hover:bg-fuchsia-700 text-white rounded-lg transition-colors cursor-pointer font-medium text-sm sm:whitespace-nowrap"
                    >
                      تطبيق
                    </button>
                  </div>
                ...
                <div className="bg-fuchsia-50 rounded-lg p-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between pt-2 border-t border-fuchsia-200">
                      <span className="text-lg font-bold">الإجمالي</span>
                      <span className="text-xl font-bold text-fuchsia-600">{formatCurrency(total, storeSettings, currencies)}</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-3">
                    {paymentMethods.map((method) => (
                      <div key={method.name} className={`border-2 rounded-lg transition-all ${
                        selectedPayment === method.name ? 'border-fuchsia-500 bg-fuchsia-50' : 'border-gray-200 hover:border-gray-300'
                      }`}>
                        <label className="flex items-center gap-4 p-4 cursor-pointer">
                          <input
                            ...
                            className="text-fuchsia-600 focus:ring-fuchsia-500"
                          />
                          <div className="w-6 h-6 text-fuchsia-600">
                            {method.icon ? (
                          ...
                          <div className="px-4 pb-4 border-t border-gray-200 mt-2 pt-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 border-2 border-fuchsia-300 rounded-lg focus:outline-none focus:border-fuchsia-500 bg-white"
                              />
                            </div>
                          </div>
                        )}
                        ...
                        {selectedPayment === method.name && method.name === 'whatsapp' && (
                          <div className="px-4 pb-4 border-t border-fuchsia-200 mt-2 pt-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none bg-white ${
                                  whatsappError ? 'border-red-500 focus:border-red-500' : 'border-fuchsia-300 focus:border-green-500'
                                }`}
                              />
                              {whatsappError && (
                                ...
                                <div key={index}>
                                  ...
                                  {field.type === 'file' ? (
                                    <input
                                      ...
                                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-fuchsia-50 file:text-fuchsia-700 hover:file:bg-fuchsia-100"
          ...
          {/* Footer */}
          <div className="p-4 md:p-6 border-t border-fuchsia-100 bg-white flex-shrink-0 shadow-lg">
            <div className="md:hidden">
              <div className="text-right mb-4">
                <p className="text-sm text-gray-600">الإجمالي</p>
                <p className="text-2xl font-bold text-fuchsia-600">{formatCurrency(total, storeSettings, currencies)}</p>
              </div>
                ...
                <div>
                  {step < 3 ? (
                    <button
                      ...
                      className="px-8 py-3 bg-fuchsia-600 hover:bg-fuchsia-700 disabled:bg-gray-300 text-white font-semibold rounded-lg transition-colors cursor-pointer disabled:cursor-not-allowed"
                    >
                      متابعة
                    </button>
                  ) : (
            ...
            <div className="hidden md:flex md:items-center md:justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-sm text-gray-600">الإجمالي</p>
                  <p className="text-xl font-bold text-fuchsia-600">{formatCurrency(total, storeSettings, currencies)}</p>
                </div>
                {step < 3 ? (
                  <button
                    onClick={handleNextStep}
