              ...
              <table className="w-full min-w-[500px]">
                <thead>
                  <tr className="border-b-2 border-fuchsia-100">
                    ...
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-fuchsia-700 text-xs md:text-sm">السعر</th>
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-fuchsia-700 text-xs md:text-sm">الضريبة</th>
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-fuchsia-700 text-xs md:text-sm">الإجمالي</th>
                  </tr>
                </thead>
                <tbody>
                  {order.items.map((item, index) => {
                    ...
                    return (
                      <tr key={index} className="border-b border-fuchsia-50 hover:bg-fuchsia-50">
                        ...
                        <td className="py-3 md:py-4 px-2 md:px-4 text-right font-semibold text-fuchsia-700 text-xs md:text-sm">{formatCurrency(itemTotalWithTax, storeSettings, currencies)}</td>
                      </tr>
                    );
                  })}
                </tbody>
