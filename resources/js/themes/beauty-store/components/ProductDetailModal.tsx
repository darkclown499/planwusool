    ...
    <div className="fixed inset-0 z-50 overflow-hidden" onClick={onClose}>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-2 md:p-4">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[85vh] md:max-h-[70vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
          ...
          {/* Header */}
          <div className="flex items-center justify-between p-4 md:p-6 border-b border-fuchsia-100">
            ...
            <div className="flex items-center gap-1">
              ...
              <button onClick={onClose} className="p-2 text-gray-400 hover:text-gray-600 hover:bg-fuchsia-50 rounded-full transition-colors">
          ...
          <div className="flex flex-col md:flex-row max-h-[calc(85vh-80px)] md:max-h-[calc(70vh-80px)] overflow-y-auto md:overflow-hidden">
            ...
            <div className="w-full md:w-2/5 p-4 md:p-6 md:sticky md:top-0 md:overflow-hidden">
              <div className="h-auto md:h-full flex flex-col space-y-4">
                <div className="relative flex-1 bg-fuchsia-50 rounded-xl overflow-hidden group">
                  <img
            ...
            {/* Product Info */}
            <div className="flex-1 md:border-l md:border-fuchsia-200 flex flex-col md:overflow-hidden">
              <div className="flex-1 md:overflow-y-auto space-y-4 md:space-y-4 pb-6 p-4 md:p-6">
                
                {/* Product Title & Category */}
                <div>
                  {product.category && (
                    <span className="inline-block bg-fuchsia-100 text-fuchsia-700 px-3 md:px-4 py-1 rounded-full text-xs md:text-sm font-medium mb-3">
                      {product.category}
                    </span>
                  )}
                ...
                <div className="bg-fuchsia-50 rounded-2xl p-4">
                  <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-4 mb-3">
                    <span className="text-2xl md:text-3xl font-bold text-fuchsia-600">
                    ...
                    {product.originalPrice && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="bg-fuchsia-500 text-white text-xs md:text-sm font-bold px-2 md:px-3 py-1 rounded-full">
                ...
                {product.customFields && product.customFields.length > 0 && (
                  <div>
                    ...
                    <div className="bg-fuchsia-50 rounded-2xl p-4 space-y-3">
                      {product.customFields.map((field, index) => (
                        <div key={index} className="flex justify-between items-center py-2 border-b border-fuchsia-200 last:border-0">
              ...
              <div className="sticky bottom-2 md:relative md:bottom-auto border-t border-fuchsia-100 pt-4 bg-white p-3 md:p-4">
                <button
                  onClick={() => {
                ...
                <WhatsAppOrderButton
                  ...
                  className="w-full py-2 md:py-3 rounded-lg font-medium text-sm transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1eb85a] text-white mt-2"
                />
              </div>
            </div>
          </div>
