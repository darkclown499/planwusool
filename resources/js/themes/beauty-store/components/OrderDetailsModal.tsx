                ...
                <table className="w-full min-w-[500px]">
                  <thead>
                    <tr className="border-b border-fuchsia-200">
                      ...
                      <th className="text-left py-2 px-2 font-semibold text-fuchsia-800 text-sm">السعر</th>
                      <th className="text-left py-2 px-2 font-semibold text-fuchsia-800 text-sm">الضريبة</th>
                      <th className="text-left py-2 px-2 font-semibold text-fuchsia-800 text-sm">الإجمالي</th>
                    </tr>
                  </thead>
                  <tbody>
