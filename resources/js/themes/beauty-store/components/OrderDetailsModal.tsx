        ...
        <div className="bg-white rounded-xl md:rounded-2xl shadow-2xl w-full max-w-4xl h-[95vh] md:h-[90vh] flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex items-center justify-between p-4 md:p-6 border-b border-fuchsia-100 flex-shrink-0">
            <div>
              ...
              <p className="text-fuchsia-600 text-sm">الطلب رقم #{orderNumber}</p>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-6">
            {/* Order Info Bar */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 p-4 bg-fuchsia-50 rounded-lg border border-fuchsia-100">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                <div className="flex items-center gap-2">
                  <span className="text-fuchsia-700 font-semibold capitalize text-sm">{order.status}</span>
                </div>
            ...
            <div className="bg-white border-2 border-fuchsia-100 rounded-xl p-4 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold text-fuchsia-800 mb-3 text-base">معلومات العميل</h3>
                ...
                <div>
                  <h3 className="font-semibold text-fuchsia-800 mb-3 text-base">عنوان الشحن</h3>
            ...
            {/* Order Items */}
            <div className="bg-white border-2 border-fuchsia-100 rounded-xl p-4 mb-6">
              <h3 className="font-semibold text-fuchsia-800 mb-4 text-base">منتجات الطلب</h3>
              <div className="overflow-x-auto">
                <table className="w-full min-w-[500px]">
                  <thead>
                    <tr className="border-b border-fuchsia-200">
                      <th className="text-right py-2 px-2 font-semibold text-fuchsia-800 text-sm">المنتج</th>
                      <th className="text-center py-2 px-2 font-semibold text-fuchsia-800 text-sm">الكمية</th>
                      <th className="text-right py-2 px-2 font-semibold text-fuchsia-800 text-sm">السعر</th>
                      <th className="text-right py-2 px-2 font-semibold text-fuchsia-800 text-sm">الضريبة</th>
                      <th className="text-right py-2 px-2 font-semibold text-fuchsia-800 text-sm">الإجمالي</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            {/* Order Summary */}
            <div className="bg-fuchsia-50 border-2 border-fuchsia-100 rounded-xl p-4">
              <h3 className="font-semibold text-fuchsia-800 mb-4 text-base">ملخص الطلب</h3>
              <div className="space-y-2">
                ...
                <div className="border-t border-fuchsia-200 pt-2">
                  <div className="flex justify-between">
                    <span className="text-base font-semibold text-gray-900">الإجمالي</span>
                    <span className="text-lg font-bold text-fuchsia-600">{formatCurrency(order.total, storeSettings, currencies)}</span>
                  </div>
                </div>
          ...
          {/* Footer */}
          <div className="border-t border-fuchsia-100 p-4 md:p-6 flex-shrink-0">
            <div className="flex justify-start">
              <button
                ...
                className="bg-fuchsia-600 hover:bg-fuchsia-700 text-white px-6 py-3 rounded-lg font-medium transition-colors cursor-pointer flex items-center gap-2 print:hidden"
              >
