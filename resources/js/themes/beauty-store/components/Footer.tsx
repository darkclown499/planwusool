          ...
          <div className="text-center md:text-right">
            ...
            {email && (
              <p className="text-gray-600">
                <span className="inline">ðŸ“§ {email}</span>
              </p>
            )}
          </div>
              ...
              <div className="flex justify-center md:justify-start gap-3 mb-2">
                {socialMedia.facebook && (
                  <a
                    ...
                    className="w-8 h-8 bg-fuchsia-100 hover:bg-fuchsia-600 hover:!text-white rounded-lg flex items-center justify-center text-fuchsia-600 transition-colors focus:outline-none"
                  >
