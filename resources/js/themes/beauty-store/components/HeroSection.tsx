...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <div className="relative bg-fuchsia-50 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8 md:py-12">
        <div className="text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-serif font-light text-gray-900 mb-4 tracking-wide">
            {welcomeMessage || (
              <>
                مرحباً بك في <br />
                <span className="font-medium text-fuchsia-600">{storeName}</span>
              </>
            )}
          </h1>
          ...
          {(address || city) && (
            <div className="flex items-center justify-center text-gray-500 mb-4">
              <svg className="w-4 h-4 md:w-5 md:h-5 mr-1 md:mr-2 text-fuchsia-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Decorative Elements */}
        <div className="absolute top-10 left-10 w-20 h-20 bg-fuchsia-100 rounded-full opacity-60 animate-pulse hidden md:block" />
        <div className="absolute bottom-10 right-10 w-16 h-16 bg-pink-100 rounded-full opacity-60 animate-pulse hidden md:block" />
        <div className="absolute top-1/2 left-5 w-12 h-12 bg-fuchsia-200 rounded-full opacity-40 animate-pulse hidden lg:block" />
      </div>
