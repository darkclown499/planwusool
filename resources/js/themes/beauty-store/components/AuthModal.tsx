  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" onClick={onClose}>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        ...
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-fuchsia-100">
          <h2 className="text-xl font-bold text-gray-900">أكمل طلبك</h2>
          <button
            onClick={onClose}
            className="p-2 text-gray-400 hover:text-gray-600 hover:bg-fuchsia-50 rounded-full transition-colors"
          >
        ...
        <div className="p-6 space-y-4">
          {/* Login Option */}
          <div className="border-2 border-gray-100 hover:border-fuchsia-200 transition-colors p-6 cursor-pointer group" onClick={onLogin}>
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-fuchsia-100 group-hover:bg-fuchsia-200 transition-colors flex items-center justify-center flex-shrink-0">
          ...
          {/* Guest Option */}
          <div className="border-2 border-gray-100 hover:border-fuchsia-200 transition-colors p-6 cursor-pointer group" onClick={onContinueAsGuest}>
            <div className="flex items-start space-x-4">
