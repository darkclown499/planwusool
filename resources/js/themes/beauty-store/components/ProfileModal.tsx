          ...
          <div className="flex mx-4 md:mx-6 mt-4 md:mt-6 mb-4 bg-gray-100 rounded-xl p-1.5">
            <button
              ...
              className={`flex-1 py-2.5 px-2 md:px-4 text-sm font-semibold rounded-lg transition-all duration-300 ${
                activeTab === 'profile'
                  ? 'bg-white text-fuchsia-600 shadow-md transform scale-[1.02]'
            ...
            {activeTab === 'profile' ? (
              ...
              <div>
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-fuchsia-600 hover:bg-fuchsia-700 text-white font-medium py-2 px-4 rounded-lg transition-colors"
                  >
                    تحديث
                  </button>
                </div>
