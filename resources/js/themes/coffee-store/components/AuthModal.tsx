        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border-2 border-stone-200" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="p-6 space-y-5">
            ...
            <button
              ...
              className="w-full bg-stone-100 hover:bg-stone-200 text-amber-700 font-bold py-4 px-6 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-3 border-2 border-stone-300 hover:border-amber-400"
            >
