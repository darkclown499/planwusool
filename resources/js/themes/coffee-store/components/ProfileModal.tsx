...
const StateDropdown: React.FC<{
  ...
  return (
    ...
    >
      <SelectTrigger className="w-full px-4 py-3 bg-white border-2 border-stone-300 rounded-xl focus:outline-none focus:border-amber-600">
              ...
              <button
                ...
                className={`flex-1 mx-1 py-3 px-4 rounded-xl font-serif font-semibold transition-all ${
                  activeTab === 'profile'
                    ...
                    : 'bg-white text-amber-700 hover:bg-stone-50'
                }`}
              >
            ...
            {activeTab === 'profile' ? (
              <form onSubmit={(e) => {
                ...
                <div className="bg-stone-50 rounded-2xl p-5 border border-stone-200 shadow-sm">
                  <h3 className="font-serif font-bold text-amber-800 mb-4 flex items-center gap-2">
                    <User className="w-5 h-5 text-amber-600" />
                    الاسم الكامل
                  </h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-amber-700 mb-2">الاسم الأول *</label>
                      <input
                        type="text"
                        value={profile.firstName || ''}
                        onChange={(e) => setProfile((prev: any) => ({ ...prev, firstName: e.target.value }))}
                        className="w-full px-4 py-3 bg-white border-2 border-stone-300 rounded-xl focus:outline-none focus:border-amber-600 transition-colors"
                        placeholder="أدخل اسمك الأول"
                        required
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-amber-700 mb-2">اسم العائلة *</label>
                      <input
                        type="text"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 bg-white border-2 border-stone-300 rounded-xl focus:outline-none focus:border-amber-600 transition-colors resize-none"
                        placeholder="أدخل عنوانك"
                        rows={3}
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-amber-700 mb-2">الدولة</label>
                      <Select
                        value={(() => {
                          const countries = (window as any).page?.props?.countries || [];
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-amber-700 mb-2">المحافظة</label>
                        <StateDropdown
                          countryId={countryId}
                      ...
                      <div>
                        <label className="block text-sm font-medium text-amber-700 mb-2">المدينة</label>
                        <CityDropdown
                          stateId={stateId}
                      ...
                      <div>
                        <label className="block text-sm font-medium text-amber-700 mb-2">الرمز البريدي</label>
                        <input
                          type="text"
                          value={profile.postalCode || ''}
                          onChange={(e) => setProfile((prev: any) => ({ ...prev, postalCode: e.target.value }))}
                          className="w-full px-4 py-1.5 bg-white border-2 border-stone-300 rounded-xl focus:outline-none focus:border-amber-600 transition-colors"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-amber-700 hover:bg-amber-800 disabled:bg-amber-400 text-white font-serif font-bold py-4 px-8 rounded-2xl transition-colors flex items-center justify-center gap-3 shadow-lg"
                >
              ...
              <form onSubmit={(e) => {
                ...
                <div className="bg-stone-50 rounded-2xl p-5 border border-stone-200 shadow-sm">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-amber-700 mb-2">كلمة المرور الحالية *</label>
                      <input
                        type="password"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-amber-700 mb-2">كلمة المرور الجديدة *</label>
                      <input
                        type="password"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-amber-700 mb-2">تأكيد كلمة المرور الجديدة *</label>
                      <input
                        type="password"
