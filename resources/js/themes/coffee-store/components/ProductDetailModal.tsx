        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[95vh] md:max-h-[80vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex flex-col md:flex-row max-h-[calc(85vh-80px)] md:max-h-[calc(70vh-80px)] overflow-y-auto md:overflow-hidden">
            ...
            <div className="w-full flex-1 flex flex-col lg:w-1/2 p-4 sm:p-6 lg:border-r border-stone-200 md:overflow-y-auto">
              <div className="flex-1 space-y-4 sm:space-y-6">
                ...
                {/* Category */}
                {product.category && (
                  <span className="inline-block bg-stone-200 text-amber-800 text-xs font-medium px-3 py-1 rounded-full">
                    {product.category}
                  </span>
                )}
                ...
                {product.description && (
                  <div>
                    ...
                    <div className="text-amber-600 text-sm leading-relaxed" dangerouslySetInnerHTML={createSafeHtml(product.description)} />
                  </div>
                )}
                    ...
                    <div className="space-y-3">
                      {product.variants.map((variant, index) => (
                        <div key={index}>
                          ...
                          >
                            <SelectTrigger className="w-full border-stone-300 focus:border-amber-500 focus:ring-amber-500">
          ...
          <div className="p-4 sm:p-6 bg-gradient-to-t from-stone-100 to-stone-50 border-t-2 border-stone-200 flex-shrink-0">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6">
              ...
              <div className="flex items-center justify-center sm:justify-start gap-3">
                ...
                <div className="flex items-center bg-white rounded-lg border border-stone-300 shadow-sm">
                  ...
                  <input
                    ...
                    className="px-4 py-2 font-bold text-amber-800 min-w-[50px] text-center border-x border-stone-200 bg-transparent focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    min="1"
              ...
              <button
                ...
                className={`flex-1 py-3 px-6 rounded-lg font-bold transition-all cursor-pointer flex items-center justify-center gap-2 ${product.availability === 'in_stock' &&
                    ...
                    : 'bg-stone-300 text-amber-500 cursor-not-allowed'
                  }`}
              >
            ...
            <WhatsAppOrderButton
              ...
              className="w-full mt-2 py-3 px-6 rounded-lg font-bold transition-all cursor-pointer flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1eb85a] text-white shadow-lg"
            />
          </div>
        </div>
      </div>
