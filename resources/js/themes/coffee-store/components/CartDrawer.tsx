...
export const CartDrawer: React.FC<CartDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute left-0 top-0 h-full w-full max-w-md bg-stone-50 shadow-2xl flex flex-col">
        ...
        <div className="bg-amber-700 text-white p-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-serif font-bold">سلة القهوة</h2>
                <p className="text-stone-300 text-sm">{cartItems.length} منتجات مميزة</p>
              </div>
            </div>
            <button onClick={onClose} className="w-10 h-10 flex items-center justify-center text-stone-300 hover:text-white hover:bg-amber-600 rounded-lg transition-colors">
              <X className="w-5 h-5" />
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto bg-stone-100">
          {cartItems.length === 0 ? (
            <div className="text-center py-16 px-6">
              ...
              <p className="text-amber-600 mb-6">أضف بعض المنتجات اللذيذة!</p>
              <button
                onClick={onClose}
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                              <button 
                                ...
                                className={`w-7 h-7 flex items-center justify-center bg-white rounded text-amber-600 transition-colors border border-stone-200 ${
                              ...
                              <button 
                                ...
                                className="w-7 h-7 flex items-center justify-center bg-white hover:bg-amber-600 hover:text-white rounded text-amber-600 transition-colors cursor-pointer border border-stone-200"
                              >
