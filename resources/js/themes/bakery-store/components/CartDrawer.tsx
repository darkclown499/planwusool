        ...
        <div className="bg-stone-700 text-white p-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-serif font-bold">سلة المخبز</h2>
                <p className="text-stone-300 text-sm">{cartItems.length} منتجات طازجة</p>
              </div>
            </div>
        ...
        <div className="flex-1 overflow-y-auto bg-stone-100">
          {cartItems.length === 0 ? (
            <div className="text-center py-16 px-6">
              ...
              <h3 className="text-xl font-serif font-bold text-stone-800 mb-3">سلتك فارغة</h3>
              <p className="text-stone-600 mb-6">أضف بعض المخبوزات الطازجة!</p>
              <button
                onClick={onClose}
                ...
                <div key={index} className="bg-white p-4 hover:bg-stone-50 transition-colors">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-medium text-stone-500 uppercase tracking-wide">منتج المخبز</span>
                    </div>
                    <button 
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="bg-stone-100 rounded-lg p-2">
                        <div className="flex flex-wrap gap-2 items-center justify-between">
                          <div className="flex items-center gap-2">
                            <span className="text-sm font-medium text-stone-700">الكمية:</span>
                            <div className="flex items-center gap-2">
                              <button 
        ...
        {cartItems.length > 0 && (
          <div className="bg-white border-t-2 border-stone-200 p-4">
            ...
            <div className="bg-stone-100 rounded-lg p-4 mb-4">
              <h3 className="font-serif font-bold text-stone-900 mb-3 text-center">ملخص الطلب</h3>
              <div className="space-y-2">
                ...
                <div className="border-t border-stone-300 pt-2 flex justify-between">
                  <span className="font-serif font-bold text-stone-900">الإجمالي</span>
