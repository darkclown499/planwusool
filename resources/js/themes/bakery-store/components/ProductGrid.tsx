            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden bg-white m-3 rounded-xl">
                ...
                <div className="absolute top-2 right-2 flex flex-col items-end space-y-2">
                  <WishlistButton productId={product.id} iconOnly />
                  {product.variants && Array.isArray(product.variants) && product.variants.length > 0 && (
                    <div className="bg-stone-600 text-white px-2 py-1 rounded text-xs font-medium shadow-lg">
                      بالخيارات
                    </div>
                  )}
                </div>
              ...
              <div className="flex-1 flex flex-col h-full px-4 pb-4">
               ...
               <div className="flex-1">
                ...
                <WhatsAppOrderButton
                  product={{ name: product.name, price: product.price }}
                  className="w-full py-3 px-4 rounded-full font-bold text-sm transition-all duration-300 shadow-md bg-[#25D366] hover:bg-[#1eb85a] text-white"
                />
