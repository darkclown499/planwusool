                ...
                {filteredOrders.map((order) => (
                  <div key={order.id} className="relative bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 border-2 border-rose-100 hover:border-rose-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                    <div className="mb-4 md:mb-5">
                      <div className="text-xs uppercase tracking-widest text-rose-500 font-semibold mb-1 md:mb-2">رقم الطلب</div>
                    ...
                    <div className="bg-rose-50 rounded-xl md:rounded-2xl p-3 md:p-4 mb-4 md:mb-5 space-y-2 md:space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-xs md:text-sm font-medium text-rose-700">تاريخ الطلب</span>
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-xs md:text-sm font-medium text-rose-700">إجمالي المنتجات</span>
                        <span className="text-xs md:text-sm font-bold text-gray-900">{order.items} منتج</span>
                      </div>
                      
                      <div className="flex justify-between items-center">
                        <span className="text-xs md:text-sm font-medium text-rose-700">الحالة</span>
                      ...
                      <div className="border-t border-rose-200 pt-2 md:pt-3 mt-2 md:mt-3">
                        <div className="flex justify-between items-center">
                          <span className="text-sm md:text-base font-bold text-rose-800">إجمالي الطلب</span>
