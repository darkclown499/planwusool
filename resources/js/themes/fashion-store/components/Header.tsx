            ...
            <div className="flex items-center gap-1 md:gap-4">
                  ...
                  {showDropdown && (
                    <div className="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-100 py-2 z-50">
                      <button
                        ...
                        className="w-full text-right px-4 py-2 text-sm text-gray-700 hover:bg-rose-50 hover:text-rose-600 flex items-center gap-3"
                      >
              ...
              {onWishlistClick && (
                ...
                >
                  ...
                  {wishlistCount > 0 && (
                    <span className="absolute -top-0.5 -left-0.5 md:-top-1 md:-left-1 bg-rose-500 text-white text-xs rounded-full h-4 w-4 md:h-5 md:w-5 flex items-center justify-center font-medium">
                      {wishlistCount}
                    </span>
                  )}
                </button>
