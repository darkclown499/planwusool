              ...
              <table className="w-full min-w-[500px]">
                <thead>
                  <tr className="border-b-2 border-rose-100">
                    ...
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">السعر</th>
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">الضريبة</th>
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">الإجمالي</th>
                  </tr>
                </thead>
                <tbody>
