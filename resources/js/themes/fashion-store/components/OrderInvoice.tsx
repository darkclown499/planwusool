        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 mb-4 md:mb-6 border-t-4 border-rose-500">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 md:mb-6">
              <div className="mb-4 md:mb-0">
                ...
                <p className="text-rose-600 text-sm md:text-base font-medium">الطلب رقم #{orderNumber}</p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 bg-rose-50 p-3 rounded-lg border border-rose-100">
              ...
              <div className="text-sm">
                <span className="text-gray-600">رقم الطلب:</span> <span className="font-semibold text-rose-700">{order.id}</span>
              </div>
            </div>
              ...
              <table className="w-full min-w-[500px]">
                <thead>
                  <tr className="border-b-2 border-rose-100">
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">المنتج</th>
                    <th className="text-center py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">الكمية</th>
                    <th className="text-left py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">السعر</th>
                    <th className="text-left py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">الضريبة</th>
                    <th className="text-left py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">الإجمالي</th>
                  </tr>
                </thead>
                <tbody>
                  {order.items.map((item, index) => {
                    ...
                    return (
                      <tr key={index} className="border-b border-rose-50 hover:bg-rose-25">
                        ...
                        <td className="py-3 md:py-4 px-2 md:px-4 text-left font-semibold text-rose-700 text-xs md:text-sm">{formatCurrency(itemTotalWithTax, storeSettings, currencies)}</td>
                      </tr>
                    );
                  })}
                </tbody>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 border border-rose-100">
            <div className="max-w-sm mr-auto">
              <h3 className="font-semibold text-rose-700 mb-4 text-sm md:text-base">ملخص الطلب</h3>
          ...
          <div className="text-center mt-8 text-gray-500 text-sm bg-white p-6 rounded-lg">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="font-medium text-rose-600">شكراً لاختيارك متجرنا!</span>
            </div>
