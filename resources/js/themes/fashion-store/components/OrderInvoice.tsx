        ...
        <div className="max-w-4xl mx-auto px-4">
              ...
              <table className="w-full min-w-[500px]">
                <thead>
                  <tr className="border-b-2 border-rose-100">
                    ...
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">Tax</th>
                    <th className="text-right py-2 md:py-3 px-2 md:px-4 font-semibold text-rose-700 text-xs md:text-sm">Total</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 border border-rose-100">
            <div className="max-w-sm ml-auto">
              <h3 className="font-semibold text-rose-700 mb-4 text-sm md:text-base">Order Summary</h3>
