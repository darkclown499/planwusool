...
export const BaseFooter: React.FC<BaseFooterProps> = ({
  ...
  const primaryColor = brandColor || themeColor || '#10b77f';
  ...
  const footerLinks = {
    ...
    support: [
      ...
      { label: t('API Reference'), href: '/api-docs' },
    ],
    legal: [
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-gray-900">{companyName || 'Wusool'}</span>
            </div>
            <p className="text-gray-600 text-sm max-w-xs mb-6">
              {t('Empowering businesses to build and grow their online presence with powerful e-commerce tools.')}
            </p>
      ...
      <div className="mt-12 pt-8 border-t border-gray-200">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {currentYear} {companyName}. {t('All rights reserved.')}
          </p>
          <div className="flex items-center gap-4 text-sm text-gray-500">
            ...
            <a href="/cookie-policy" className="hover:text-primary transition-colors">{t('Cookie Policy')}</a>
          </div>
        </div>
      </div>
    </div>
