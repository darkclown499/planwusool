        ...
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-[800px] max-h-[90vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-between p-4 border-b border-gray-100">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <WishlistButton productId={product.id} iconOnly className="p-2 hover:bg-gray-100 rounded-full transition-colors cursor-pointer" />
              ...
              <div className="space-y-4 md:space-y-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-2xl font-bold text-orange-600">{formatCurrency(product.price, storeSettings, currencies)}</span>
                ...
                <WhatsAppOrderButton
                  ...
                  className="w-full py-3 md:py-2.5 px-6 mb-3 md:px-4 rounded-xl md:rounded-lg font-semibold md:text-sm transition-colors flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1eb85a] text-white"
                />
