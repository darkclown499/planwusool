              ...
              {[1, 2, 3].map((stepNum) => (
                <div key={stepNum} className="flex items-center">
                  ...
                  <div className="flex flex-col items-center md:hidden">
                    ...
                    <span className={`mt-1 text-xs ${step >= stepNum ? 'text-orange-600 font-semibold' : 'text-gray-500'}`}>
                  ...
                  <div className="hidden md:flex md:items-center">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${step >= stepNum ? 'bg-orange-600 text-white' : 'bg-gray-200 text-gray-600'
                      }`}>
                      {stepNum}
                    </div>
                    <span className={`mr-2 text-sm ${step >= stepNum ? 'text-orange-600 font-semibold' : 'text-gray-500'}`}>
                      {stepNum === 1 ? 'المعلومات' : stepNum === 2 ? 'المراجعة' : 'الدفع'}
                    </span>
                  </div>

                  {stepNum < 3 && <div className={`w-6 md:w-16 h-0.5 mr-2 md:mr-4 ${step > stepNum ? 'bg-orange-600' : 'bg-gray-200'}`}></div>}
                </div>
              ))}
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 text-base ${emailError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-orange-500'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 text-base ${phoneError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-orange-500'
                        }`}
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between mb-2">
                            <p className="text-orange-600 font-bold text-lg">{formatCurrency(item.price * item.quantity, storeSettings, currencies)}</p>
                            <button
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3 bg-gray-100 rounded-lg p-1">
                              <button
                                ...
                                className={`w-7 h-7 flex items-center justify-center rounded-md text-white text-sm shadow-sm font-bold leading-none ${item.quantity > 1 ? 'bg-orange-600 hover:bg-orange-700 cursor-pointer' : 'bg-gray-400 cursor-not-allowed'
                                  }`}
                              >
                                −
                              </button>
                              ...
                              <button
                                ...
                                className="w-7 h-7 flex items-center justify-center bg-orange-600 hover:bg-orange-700 rounded-md text-white text-sm cursor-pointer shadow-sm font-bold leading-none"
                              >
                                +
                              </button>
                            </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className={`flex-1 px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 text-base bg-white ${couponError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-orange-500'
                        }`}
                    />
                    <button
                      onClick={() => handleApplyCoupon(subtotal)}
                      className="px-4 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors cursor-pointer font-medium text-sm sm:whitespace-nowrap"
                    >
                      تطبيق
                    </button>
                  </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between pt-2 border-t border-gray-200">
                      ...
                      <span className="text-xl font-bold text-orange-600">{formatCurrency(total, storeSettings, currencies)}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {loadingPayments ? (
                  ...
                  <div className="space-y-3">
                    {paymentMethods.map((method) => (
                      <div key={method.name} className={`border-2 rounded-lg transition-all ${selectedPayment === method.name ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-gray-300'
                        }`}>
                        ...
                        {selectedPayment === method.name && method.name === 'bank' && method.details && (
                          <div className="px-4 pb-4 border-t border-gray-200 mt-2 pt-4">
                            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
                              <h5 className="font-semibold text-orange-900 mb-2">تفاصيل التحويل البنكي</h5>
                              <div className="text-sm text-orange-800 whitespace-pre-line">{method.details}</div>
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-orange-500 bg-white"
                              />
                            </div>
                          </div>
                        )}
          ...
          <div className="p-4 md:p-6 border-t border-gray-100 bg-white flex-shrink-0 shadow-lg">
            ...
            <div className="md:hidden">
              <div className="text-right mb-4">
                ...
                <p className="text-2xl font-bold text-orange-600">{formatCurrency(total, storeSettings, currencies)}</p>
              </div>
                ...
                <div>
                  {step < 3 ? (
                    <button
                      ...
                      className="px-8 py-3 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-300 text-white font-semibold rounded-lg transition-colors cursor-pointer disabled:cursor-not-allowed"
                    >
                      متابعة
                    </button>
                  ) : (
            ...
            <div className="hidden md:flex md:items-center md:justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-sm text-gray-600">الإجمالي</p>
                  <p className="text-xl font-bold text-orange-600">{formatCurrency(total, storeSettings, currencies)}</p>
                </div>
                {step < 3 ? (
                  <button
                    onClick={handleNextStep}
