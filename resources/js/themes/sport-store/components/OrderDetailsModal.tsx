                ...
                <table className="w-full min-w-[500px]">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-right py-2 px-2 font-semibold text-gray-900 text-sm">السعر</th>
                      <th className="text-right py-2 px-2 font-semibold text-gray-900 text-sm">الضريبة</th>
                      <th className="text-right py-2 px-2 font-semibold text-gray-900 text-sm">الإجمالي</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <div className="space-y-2">
                ...
                <div className="border-t pt-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-lg font-bold text-orange-600">{formatCurrency(order.total, storeSettings, currencies)}</span>
                  </div>
                </div>
          ...
          <div className="border-t border-gray-100 p-4 md:p-6 flex-shrink-0">
            <div className="flex justify-start">
              <button
                ...
                className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg font-medium transition-colors cursor-pointer flex items-center gap-2 print:hidden"
              >
