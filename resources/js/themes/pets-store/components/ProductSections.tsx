    ...
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 group overflow-hidden border border-gray-200">
      ...
      <div className="relative aspect-square bg-gradient-to-br from-orange-50 to-orange-100 overflow-hidden">
        ...
        {product.variants && product.variants.length > 0 && (
          <div className="absolute top-3 left-3 bg-orange-600 text-white px-3 py-1 rounded-full text-xs font-medium shadow-lg">
            خيارات
          </div>
        )}
      ...
      <div>
        ...
        <div className="px-5 pb-5">
          <h3 
            onClick={() => onProductClick(product)}
            className="font-semibold text-gray-900 mb-2 line-clamp-2 text-sm leading-5 cursor-pointer hover:text-orange-600"
          >
            {product.name}
          </h3>
                ...
                <section key={category.id} id={`category-${category.id}`}>
                  ...
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      ...
                      <p className="text-gray-600">
                        {category.description || `منتجات ${category.name} عالية الجودة لحيوانك الأليف`}
                      </p>
                    </div>
                  </div>
