...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <div className="relative bg-orange-700 text-white overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="text-center">
          ...
          {description && (
            <p className="break-all text-base md:text-lg text-orange-100 leading-relaxed mb-8 max-w-2xl mx-auto">
              {description}
            </p>
          )}
          ...
          {fullAddress && (
            <div className="bg-white rounded-lg p-4 mx-auto max-w-md mb-4 md:mb-0">
              <h3 className="font-semibold text-orange-700 mb-2">📍 موقع المتجر</h3>
