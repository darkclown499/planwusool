        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
              ...
              <form onSubmit={handleSearch} className="w-full">
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-12 pl-4 py-3 border-2 border-orange-200 rounded-full focus:outline-none focus:border-orange-500 text-gray-700"
                  />
                  <Search className="absolute right-4 top-1/2 transform -translate-y-1/2 text-orange-500 w-5 h-5" />
                  <button
                    type="submit"
                    className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-orange-600 text-white px-6 py-2 rounded-full hover:bg-orange-700 transition-colors"
                  >
                    بحث
                  </button>
                </div>
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              <button
                onClick={onCartClick}
                className="relative p-2 md:p-3 bg-orange-100 rounded-full hover:bg-orange-200 transition-colors"
              >
                <ShoppingCart className="w-5 h-5 md:w-6 md:h-6 text-orange-700" />
                {cartCount > 0 && (
                  <span className="absolute -top-1 -left-1 md:-top-2 md:-left-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 md:w-6 md:h-6 flex items-center justify-center font-bold">
                ...
                {isLoggedIn ? (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-orange-600 font-semibold">{userName}</p>
                    </div>
                  </button>
                ) : (
                  <button
              ...
              <form onSubmit={handleSearch}>
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-9 pl-9 py-2.5 border border-orange-200 rounded-lg focus:outline-none focus:border-orange-500 text-sm"
                    autoFocus
                  />
                  <Search className="absolute right-2.5 top-1/2 transform -translate-y-1/2 text-orange-500 w-4 h-4" />
                  <button
                    type="button"
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-3 bg-orange-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-orange-600 font-semibold">{userName}</p>
                    </div>
                  </div>
                  <button
                    onClick={() => {
