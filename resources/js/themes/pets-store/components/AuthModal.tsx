        ...
        >
          ...
          <div className="relative p-6 md:p-8 text-center bg-gradient-to-br from-orange-50 to-orange-100">
            <button 
              ...
              className="absolute top-4 left-4 p-2 text-gray-600 hover:text-gray-800 hover:bg-orange-200 rounded-full transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <p className="text-gray-600">اختر كيف تفضل إتمام طلبك</p>
          </div>
          ...
          <div className="p-6 md:p-8 space-y-4">
            ...
            <button
              onClick={onLogin}
              className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-4 px-6 rounded-2xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-3 group"
            >
