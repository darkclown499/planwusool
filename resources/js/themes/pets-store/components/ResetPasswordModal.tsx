            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    required
                    minLength={8}
                    className="w-full pr-10 pl-12 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500"
              ...
              <p className="text-center text-sm text-gray-600">
                ...
                <button 
                  onClick={onClose}
                  type="button" 
                  className="text-orange-600 hover:text-orange-700 font-medium mr-1"
                >
                  تسجيل الدخول
                </button>
              </p>
