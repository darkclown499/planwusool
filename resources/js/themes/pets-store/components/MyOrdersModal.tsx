          ...
          <div className="p-4 md:p-6 border-b bg-white space-y-3 md:space-y-0 md:flex md:items-center md:gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pr-10 pl-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
              />
            </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      ...
                      <div className="flex-shrink-0">
                        <button
                          ...
                          className="w-full md:w-auto bg-orange-600 hover:bg-orange-700 text-white px-4 py-2.5 rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
                        >
