  ...
  return (
    <div className="fixed inset-0 z-60 bg-black/50" onClick={(e) => e.stopPropagation()}>
      <div className="flex items-end md:items-center justify-center min-h-full p-0 md:p-4">
        ...
        >
          {/* Header */}
          <div className="relative p-6 md:p-8 text-center bg-gradient-to-br from-orange-50 to-orange-100">
            <button
              onClick={onClose}
              className="absolute top-4 left-4 p-2 text-gray-600 hover:text-gray-800 hover:bg-orange-200 rounded-full transition-colors md:hidden cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>

            {/* Success Animation */}
            <div className="w-20 h-20 md:w-24 md:h-24 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 shadow-lg animate-pulse">
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4">
              <div className="text-center">
                <p className="text-sm text-orange-700 font-medium mb-1">رقم الطلب</p>
              ...
              <div className="bg-gray-50 rounded-2xl p-4 pb-0">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <input
                    ...
                    value={orderLink}
                    readOnly
                    className="flex-1 text-sm bg-white border border-gray-300 rounded-xl px-3 py-2.5 text-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500"
                  />
                  <button
                    onClick={copyOrderLink}
                    className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2.5 rounded-xl text-sm font-medium transition-colors flex items-center justify-center gap-2 whitespace-nowrap cursor-pointer"
                  >
          ...
          <div className="flex-shrink-0 p-6 md:p-8 pt-0 space-y-3">
            <button
              ...
              className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-4 px-6 rounded-2xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 cursor-pointer"
            >
