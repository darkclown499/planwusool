  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50">
      <div className="flex items-end md:items-center justify-center h-full p-0 md:p-4">
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 md:p-6 border-b bg-gradient-to-r from-orange-50 to-orange-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">أكمل طلبك الآن</p>
              </div>
            </div>
            <button 
              onClick={onClose} 
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 ${
                          emailError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-orange-500 focus:border-orange-500'
                        }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 ${
                          phoneError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-orange-500 focus:border-orange-500'
                        }`}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-1.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
              ...
              <div className="p-4 md:p-6">
                ...
                <div className="space-y-4 mb-6">
                  {cartItems.map((item, index) => (
                    <div key={index} className="bg-orange-50 rounded-2xl p-3 sm:p-4 border border-orange-100">
                              ...
                              <div className="flex items-center gap-1 sm:gap-2 bg-white rounded-xl p-1">
                                <button 
                                  ...
                                  className={`w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-lg ${
                                    item.quantity > 1 ? 'bg-orange-600 hover:bg-orange-700 text-white' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                                  } transition-colors`}
                                >
                                ...
                                <button 
                                  ...
                                  className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors"
                                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className={`flex-1 px-3 sm:px-4 py-2.5 sm:py-3 border rounded-xl focus:outline-none focus:ring-2 text-sm sm:text-base ${
                        couponError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-orange-500'
                      }`}
                    />
                    <button
                      onClick={() => handleApplyCoupon(subtotal)}
                      className="px-4 sm:px-6 py-2.5 sm:py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-medium transition-colors text-sm sm:text-base whitespace-nowrap"
                    >
                      تطبيق
                    </button>
                  </div>
                  {couponError && <p className="text-red-500 text-xs sm:text-sm mt-2">{couponError}</p>}
                  {appliedCoupon && <p className="text-orange-600 text-xs sm:text-sm mt-2">✓ تم تطبيق الكوبون "{appliedCoupon.code}"</p>}
                </div>
                  ...
                  {loadingShipping ? (
                    ...
                    <div className="space-y-2">
                      {shippingMethods.map((method) => (
                        <label key={method.id} className="flex items-center gap-3 p-3 border rounded-xl cursor-pointer hover:bg-orange-50">
                          <input
                            type="radio"
                            name="shipping"
                            value={method.id}
                  ...
                  <div className="space-y-3">
                    {paymentMethods.map((method) => (
                      <div key={method.name} className={`border-2 rounded-2xl transition-all ${
                        selectedPayment === method.name ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-gray-300'
                      }`}>
                        <label className="flex items-center gap-4 p-4 cursor-pointer">
                          <input
                            ...
                            className="text-orange-600"
                          />
                          <div className="w-6 h-6 text-orange-600 flex-shrink-0">
                            {method.icon ? (
                        ...
                        {selectedPayment === method.name && method.name === 'whatsapp' && (
                          <div className="px-4 pb-4 border-t border-gray-200 mt-2 pt-4">
                            <div className="bg-orange-50 border border-orange-200 rounded-2xl p-4 mb-4">
                              <h5 className="font-semibold text-amber-900 mb-2">الدفع عبر واتساب</h5>
                              <div className="text-sm text-orange-800">سيتم تحويلك إلى واتساب لإتمام عملية الدفع.</div>
                            </div>
                            <div>
                              <label className="block text-sm font-semibold text-gray-800 mb-2">
                                رقم واتساب *
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none bg-white ${
                                  whatsappError ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-orange-500'
                                }`}
                              />
                              {whatsappError && (
                ...
                <div className="flex-1">
                  {step < 3 ? (
                    <button
                      ...
                      className="w-full px-6 py-3 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-300 text-white font-semibold rounded-xl transition-colors disabled:cursor-not-allowed text-sm"
                    >
                      متابعة
                    </button>
                  ) : (
              ...
              <div className="flex items-center gap-4">
                ...
                {step < 3 ? (
                  <button
                    ...
                    className="px-8 py-3 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-300 text-white font-semibold rounded-xl transition-colors disabled:cursor-not-allowed"
                  >
                    متابعة
                  </button>
                ) : (
