...
A modern, fresh grocery store theme designed for petss, grocery stores, and food retailers.

## Theme Overview

The Pets theme provides a clean, professional interface optimized for grocery shopping with:
...
- **Pet Stores**: Large grocery chains
...
To use this theme, set the store's theme to `pets` in the database or admin panel.