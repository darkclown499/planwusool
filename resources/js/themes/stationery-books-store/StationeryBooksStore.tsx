...
import { stationeryBooksConfig } from './config';

export const StationeryBooksStore: React.FC<MasalahStoreProps> = (props) => {
  return (
    <PWAProvider store={props.store}>
      <ThemeProvider
        ...
        action={props.action}
      >
        <MasalahThemeProvider config={stationeryBooksConfig}>
          <MasalahStore />
