  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col border border-amber-200">
          <div className="relative bg-amber-700 p-4 sm:p-5 flex-shrink-0">
            ...
            <div className="text-center text-white">
              ...
              <h2 className="text-xl sm:text-2xl font-serif font-bold mb-1">إعادة تعيين كلمة المرور</h2>
              <p className="text-amber-200 text-xs sm:text-sm">أنشئ كلمة مرور جديدة لحسابك</p>
            </div>
          </div>
          ...
          <div className="p-6 overflow-y-auto">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button 
                type="submit" 
                className="w-full py-3 px-4 rounded-lg font-medium transition-colors bg-amber-700 hover:bg-amber-800 text-white cursor-pointer"
              >
