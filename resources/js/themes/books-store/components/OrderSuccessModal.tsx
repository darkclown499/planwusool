              ...
              <div className="bg-amber-100 rounded-xl p-4 mb-6">
                ...
                <div className="flex gap-2">
                  <input 
                    ...
                    value={orderLink}
                    readOnly
                    className="flex-1 text-xs sm:text-sm bg-white border border-amber-300 rounded-lg px-3 py-2 text-amber-600 truncate"
                  />
                  <button
            ...
            <div className="space-y-3">
              ...
              {orderNumber && (
                <a
                  ...
                  className="w-full bg-amber-100 hover:bg-amber-200 text-amber-700 font-semibold py-3 px-6 rounded-2xl transition-all flex items-center justify-center gap-3 border border-amber-300 cursor-pointer"
                >
