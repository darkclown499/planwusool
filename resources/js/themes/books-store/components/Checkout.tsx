  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-2 sm:p-4">
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl h-[95vh] flex flex-col overflow-hidden border-2 border-amber-200" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="relative bg-amber-700 p-4 sm:p-5 flex-shrink-0">
            ...
            <div className="flex items-center justify-center text-white pl-10">
              ...
              <div>
                ...
                <p className="text-amber-200 text-xs sm:text-sm">أكمل طلبك</p>
              </div>
            </div>
          </div>
                ...
                <div key={stepItem.num} className="flex items-center">
                  ...
                  {index < 2 && (
                    <div className={`w-4 sm:w-16 h-1 mr-2 sm:mr-4 rounded-full ${
                      step > stepItem.num ? 'bg-amber-700' : 'bg-amber-200'
                    }`}></div>
                  )}
                </div>
              ))}
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border-2 border-amber-300 rounded-lg focus:outline-none focus:border-amber-600 transition-colors"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none transition-colors ${
                          emailError ? 'border-red-500 focus:border-red-600' : 'border-amber-300 focus:border-amber-600'
                        }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none transition-colors ${
                          phoneError ? 'border-red-500 focus:border-red-600' : 'border-amber-300 focus:border-amber-600'
                        }`}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        >
                          <SelectTrigger className="w-full px-4 border-2 border-amber-300 focus:border-amber-600 focus:ring-amber-600">
                      ...
                      <div>
                        ...
                        <StateDropdown
                          ...
                          className="w-full px-4 py-3 border-2 border-amber-300 rounded-lg focus:outline-none focus:border-amber-600 focus:ring-amber-600 transition-colors"
                          disabled={!countryId}
                        />
                      </div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-1.5 border-2 border-amber-300 rounded-lg focus:outline-none focus:border-amber-600 transition-colors"
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  {cartItems.map((item, index) => (
                    <div key={index} className="bg-amber-50 rounded-xl p-3 sm:p-4 border-2 border-amber-200">
                      <div className="flex items-start gap-3 sm:gap-4">
                        <img src={getImageUrl(item.image)} alt={item.name} className="w-16 h-16 sm:w-20 sm:h-20 object-cover rounded-lg border-2 border-amber-300 flex-shrink-0" />
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3">
                              <div className="flex items-center bg-white rounded-lg border-2 border-amber-300">
                                <button 
                                  onClick={() => item.quantity > 1 && onUpdateQuantity(index, -1)}
                                  className={`p-1.5 sm:p-2 rounded-r-lg transition-colors ${
                                    item.quantity > 1 ? 'hover:bg-amber-100 cursor-pointer' : 'cursor-not-allowed opacity-50'
                                  }`}
                                >
                                ...
                                <button 
                                  ...
                                  className="p-1.5 sm:p-2 hover:bg-amber-100 rounded-l-lg transition-colors"
                                >
                  ...
                  <div className="bg-amber-50 rounded-xl p-4 sm:p-6 border-2 border-amber-200">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <input
                        ...
                        className="flex-1 px-3 sm:px-4 py-2 sm:py-3 border-2 border-amber-300 rounded-lg focus:outline-none focus:border-amber-600 text-sm sm:text-base"
                      />
                      <button
                    ...
                    {loadingShipping ? (
                      ...
                      <div className="space-y-3">
                        {shippingMethods.map((method) => (
                          <label key={method.id} className="flex items-center gap-3 p-3 border-2 border-amber-300 rounded-lg cursor-pointer bg-white hover:bg-amber-50 transition-colors">
                            <input
                              type="radio"
                              name="shipping"
                              value={method.id}
                    ...
                    <div className="space-y-4">
                      {paymentMethods.map((method) => (
                        <div key={method.name} className={`border-2 rounded-xl transition-all ${
                          selectedPayment === method.name ? 'border-amber-700 bg-amber-50' : 'border-amber-300 hover:border-amber-400'
                        }`}>
                          ...
                          {selectedPayment === method.name && method.name === 'bank' && method.details && (
                            <div className="px-4 pb-4 border-t border-amber-200 mt-2 pt-4">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full px-4 py-3 border-2 border-amber-300 rounded-xl focus:outline-none focus:border-amber-700 bg-amber-50/30"
                                />
                              </div>
                            </div>
                          )}
                            ...
                            <div className="px-4 pb-4 border-t border-amber-200 mt-2 pt-4">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none bg-amber-50/30 ${
                                    whatsappError ? 'border-red-500 focus:border-red-500' : 'border-amber-300 focus:border-green-500'
                                  }`}
                                />
                                {whatsappError && (
          ...
          {/* Footer */}
          <div className="p-4 sm:p-6 border-t-2 border-amber-200 bg-gradient-to-r from-amber-50 to-amber-100">
            {/* Mobile Layout */}
              ...
              <div className="flex gap-3">
                {step > 1 && (
                  <button
                    ...
                    className="flex-1 px-4 py-3 border-2 border-amber-300 text-amber-700 rounded-lg hover:bg-amber-100 transition-colors font-semibold text-sm"
                  >
                    رجوع
                  </button>
                )}
                {step < 3 ? (
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-amber-700 hover:bg-amber-800 disabled:bg-amber-300 text-white font-bold rounded-lg transition-colors disabled:cursor-not-allowed shadow-lg text-sm"
                  >
                    متابعة
                  </button>
                ) : (
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-amber-700 hover:bg-amber-800 disabled:bg-amber-300 text-white font-bold rounded-lg transition-colors disabled:cursor-not-allowed shadow-lg text-sm flex items-center justify-center gap-2"
                  >
            ...
            <div className="hidden sm:flex items-center justify-between">
              <div>
                {step > 1 && (
                  <button
                    onClick={handlePrevStep}
                    className="px-6 py-3 border-2 border-amber-300 text-amber-700 rounded-lg hover:bg-amber-100 transition-colors font-semibold"
                  >
                    رجوع
                  </button>
                )}
              ...
              <div className="flex items-center gap-6">
                ...
                {step < 3 ? (
                  <button
                    ...
                    className="px-8 py-3 bg-amber-700 hover:bg-amber-800 disabled:bg-amber-300 text-white font-bold rounded-lg transition-colors disabled:cursor-not-allowed shadow-lg"
                  >
                    متابعة
                  </button>
                ) : (
                  <button
                    onClick={() => handlePlaceOrder(total)}
                    disabled={isPlacingOrder || !selectedPayment || (selectedPayment === 'whatsapp' && !whatsappNumber.trim())}
                    className="px-8 py-3 bg-amber-700 hover:bg-amber-800 disabled:bg-amber-300 text-white font-bold rounded-lg transition-colors disabled:cursor-not-allowed shadow-lg flex items-center gap-2"
                  >
