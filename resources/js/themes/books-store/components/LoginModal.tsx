    ...
    return (
      <div className="fixed inset-0 z-50 overflow-hidden" onClick={onClose}>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col border border-amber-200" onClick={(e) => e.stopPropagation()}>
            <div className="relative bg-amber-700 p-4 sm:p-5 flex-shrink-0">
              ...
              <div className="text-center text-white">
                ...
                <p className="text-amber-200 text-xs sm:text-sm">أعد تعيين كلمة مرور حسابك</p>
              </div>
            </div>
            <div className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-center text-sm text-amber-600">
                  ...
                  <button 
                    ...
                    type="button" 
                    className="text-amber-700 hover:text-amber-900 font-medium ml-1 transition-colors cursor-pointer"
                  >
                    تسجيل الدخول
                  </button>
                </p>
        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col border border-amber-200" onClick={(e) => e.stopPropagation()}>
          <div className="relative bg-amber-700 p-4 sm:p-5 flex-shrink-0">
            ...
            <div className="text-center text-white">
              ...
              <p className="text-amber-200 text-xs sm:text-sm">{isLogin ? 'مرحباً بعودتك إلى متجرنا' : 'أنشئ حسابك'}</p>
            </div>
          </div>
          <div className="p-6 overflow-y-auto">
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <>
                  <div>
                    ...
                    <input 
                      ...
                      required 
                      className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 transition-colors ${
                        errors.first_name ? 'border-red-500' : 'border-amber-300'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      required 
                      className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 transition-colors ${
                        errors.last_name ? 'border-red-500' : 'border-amber-300'
                      }`}
                    />
              ...
              {!isLogin && (
                <div>
                  ...
                  <input 
                    ...
                    required 
                    className="w-full px-4 py-2 border border-amber-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 transition-colors" 
                  />
                  <p className="text-xs text-amber-500 mt-1">يرجى استخدام رمز الدولة (مثال: 970+)</p>
                </div>
              )}
              <div>
                <label className="block text-sm font-medium text-amber-700 mb-2">كلمة المرور</label>
                <input 
                  type="password" 
                  value={password}
              ...
              {!isLogin && (
                <div>
                  <label className="block text-sm font-medium text-amber-700 mb-2">تأكيد كلمة المرور</label>
                  <input 
                    type="password" 
                    ...
                    required 
                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 transition-colors ${
                      errors.password_confirmation ? 'border-red-500' : 'border-amber-300'
                    }`}
                  />
              ...
              {isLogin && (
                <button 
                  ...
                  type="button" 
                  className="text-amber-700 hover:text-amber-900 text-sm transition-colors cursor-pointer"
                >
                  نسيت كلمة المرور؟
                </button>
              )}
