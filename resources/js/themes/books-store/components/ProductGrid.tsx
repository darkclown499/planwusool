    ...
    <>
      ...
      <div className="block md:hidden px-2">
        {products.map((product) => (
          <div
            key={product.id}
            className="bg-white rounded-lg shadow-sm border border-amber-200 mb-3 overflow-hidden"
          >
            <div className="flex p-3">
              {/* Product Image */}
              <div className="relative w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden bg-amber-100 group/image">
                <img
      ...
      <div className="hidden md:grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {products.map((product) => {
          ...
          return (
            <div
              key={product.id}
              className="group flex flex-col bg-amber-50 border-2 border-amber-200 hover:border-amber-400 transition-all duration-300 overflow-hidden relative"
