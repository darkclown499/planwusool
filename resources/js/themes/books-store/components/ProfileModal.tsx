...
const StateDropdown: React.FC<{
  ...
  if (disabled || !countryId) {
    return (
      <Select disabled>
        <SelectTrigger className="w-full px-4 py-3 bg-white border-2 border-amber-300 rounded-xl">
  ...
  return (
    ...
    >
      <SelectTrigger className="w-full px-4 py-3 bg-white border-2 border-amber-300 rounded-xl focus:outline-none focus:border-amber-600">
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" onClick={onClose}>
      ...
      <div className="absolute inset-0 flex items-end sm:items-center justify-center p-2 sm:p-4">
        <div className="bg-amber-50 w-full sm:max-w-2xl max-h-[95vh] sm:max-h-[90vh] rounded-t-2xl sm:rounded-2xl shadow-2xl border border-amber-200 flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="relative bg-amber-700 p-4 sm:p-5 flex-shrink-0">
            ...
            <div className="text-center text-white">
              ...
              <p className="text-amber-200 text-xs sm:text-sm">إدارة معلومات حسابك</p>
            </div>
          </div>

          {/* Tab Design */}
          <div className="bg-amber-100 border-b border-amber-200 flex-shrink-0">
