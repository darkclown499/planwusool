...
export const CategoryTabs: React.FC<CategoryTabsProps> = ({
  ...
  return (
    <div className="sticky top-16 z-40 bg-amber-50 py-3 shadow-sm">
              ...
              <button
                ...
                className={`
                  ...
                  ${isActive
                    ...
                    : 'bg-white text-amber-800 border-amber-200 hover:border-amber-400 hover:bg-amber-100 hover:shadow-sm'
                  }
                `}
              >
