        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-amber-200">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
              ...
              <div className="flex gap-3 print:hidden">
                <button
                  onClick={handlePrint}
                  className="bg-amber-100 hover:bg-amber-200 text-amber-700 px-4 py-2 rounded-xl transition-colors flex items-center gap-2 font-serif font-semibold"
                >
                        ...
                        {variants && Object.keys(variants).length > 0 && (
                          <div className="flex flex-wrap gap-1 mb-2">
                            {Object.entries(variants).map(([key, value], idx) => (
                              <span key={key} className="bg-amber-200 px-2 py-1 rounded text-xs text-amber-700">
                                {key}: {value}
                              </span>
                            ))}
                          </div>
          ...
          <div className="text-center mt-8 text-amber-600">
            <div className="bg-white rounded-2xl p-6 border border-amber-200">
              ...
              <p className="text-sm">نقدّر ثقتك ونتمنى أن تستمتع بقراءتك القادمة.</p>
