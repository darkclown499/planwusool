...
const BooksStoreContent: React.FC = () => {
        ...
        <div className="max-w-7xl mx-auto px-4">
          {categories.map((category) => (
            <div key={category.id} id={`category-${category.id}`} className="mb-12 md:mb-16">
              <div className="text-center mb-8 py-8 px-6 rounded-lg bg-gradient-to-r from-amber-100 to-amber-50 border border-amber-200">
...
export const BooksStore: React.FC<BooksStoreProps> = (props) => {
  return (
