            ...
            <button
              ...
              className={`flex-shrink-0 px-4 py-2 text-sm font-medium rounded-full transition-all duration-200 md:px-5 md:py-2.5 md:shadow-sm md:border cursor-pointer ${
                activeCategory === category.id
                  ? 'bg-sky-600 text-white md:bg-sky-600 md:text-white md:border-sky-600'
                  : 'text-gray-600 bg-gray-100 hover:bg-gray-200 md:bg-white md:text-gray-700 md:hover:bg-sky-50 md:hover:text-sky-600 md:border-gray-200'
              }`}
            >
              {category.name}
            </button>
