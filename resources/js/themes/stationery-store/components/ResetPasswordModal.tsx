        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="p-6 overflow-y-auto">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button 
                type="submit" 
                className="w-full py-2 px-4 rounded-lg font-medium transition-colors bg-sky-600 hover:bg-sky-700 cursor-pointer text-white"
              >
              ...
              <p className="text-center text-sm text-gray-600">
                ...
                <button 
                  onClick={onClose}
                  type="button" 
                  className="text-sky-600 hover:text-sky-700 font-medium mr-1 cursor-pointer"
                >
                  تسجيل الدخول
                </button>
              </p>
