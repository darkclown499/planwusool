        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-4 relative">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-2.5 text-sm bg-gray-50 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent focus:bg-white transition-all"
            />
          </div>
          ...
          {isLoggedIn ? (
            <div className="relative">
              <button 
                ...
                className="flex-shrink-0 bg-sky-600 hover:bg-sky-700 text-white px-3 md:px-6 py-2.5 rounded-full text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer flex items-center gap-1 md:gap-2"
              >
            ...
            <button 
              ...
              className="flex-shrink-0 bg-sky-600 hover:bg-sky-700 text-white px-3 md:px-6 py-2.5 rounded-full text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer flex items-center justify-center"
            >
        ...
        <div className="md:hidden bg-white border-b border-gray-200 px-4 py-3">
          <div className="relative">
            ...
            <input
              ...
              value={searchQuery}
              onChange={handleSearchChange}
              className="w-full pr-10 pl-10 py-2.5 text-sm bg-gray-50 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent focus:bg-white transition-all"
              autoFocus
            />
            <button 
              onClick={toggleMobileSearch}
