              ...
              <div className="space-y-2">
                ...
                <div className="border-t pt-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-lg font-bold text-sky-600">{formatCurrency(order.total, storeSettings, currencies)}</span>
                  </div>
                </div>
          ...
          <div className="border-t border-gray-100 p-4 md:p-6 flex-shrink-0">
            <div className="flex justify-start">
              <button
                ...
                className="bg-sky-600 hover:bg-sky-700 text-white px-6 py-3 rounded-lg font-medium transition-colors cursor-pointer flex items-center gap-2 print:hidden"
              >
