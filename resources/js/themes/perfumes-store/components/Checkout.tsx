  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70">
      <div className="flex items-end md:items-center justify-center h-full p-0 md:p-4">
        <div 
          className="bg-slate-800 w-full h-full md:h-[95vh] md:max-w-5xl overflow-hidden shadow-2xl flex flex-col border-2 border-amber-600"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 md:p-6 border-b-2 border-amber-600 bg-black">
          ...
          {/* Progress Steps */}
          <div className="px-4 md:px-6 py-4 bg-slate-900 border-b-2 border-amber-600">
                  ...
                  <div key={stepNum} className="flex items-center">
                    <div className="flex flex-col items-center">
                      <div className={`w-10 h-10 flex items-center justify-center transition-all ${
                        ...
                        isActive ? 'bg-amber-600 text-white' : 'bg-slate-600 text-slate-400'
                      }`}>
                    ...
                    {stepNum < 3 && (
                      <div className={`w-12 md:w-20 h-0.5 mx-2 transition-all ${
                        step > stepNum ? 'bg-amber-600' : 'bg-slate-600'
                      }`}></div>
                    )}
                  </div>
                );
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-slate-800 border-2 border-slate-600 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-slate-800 border-2 text-white placeholder-slate-400 focus:outline-none focus:ring-2 ${
                          emailError ? 'border-amber-500 focus:ring-amber-500' : 'border-slate-600 focus:ring-amber-500 focus:border-amber-500'
                        }`}
                        placeholder="أدخل بريدك الإلكتروني"
                      />
                      {emailError && <p className="text-amber-400 text-sm mt-1 font-medium">{emailError}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-slate-800 border-2 text-white placeholder-slate-400 focus:outline-none focus:ring-2 ${
                          phoneError ? 'border-amber-500 focus:ring-amber-500' : 'border-slate-600 focus:ring-amber-500 focus:border-amber-500'
                        }`}
                        placeholder="+1 (555) 123-4567"
                      />
                      {phoneError && <p className="text-amber-400 text-sm mt-1 font-medium">{phoneError}</p>}
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        >
                          <SelectTrigger className="focus:ring-amber-500 focus:border-amber-500 bg-slate-800 border-slate-600 text-white">
                      ...
                      <div>
                        ...
                        <StateDropdown
                          ...
                          className="w-full px-4 py-3 bg-slate-800 border-2 border-slate-600 text-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                          disabled={!countryId}
                        />
                      </div>
                    </div>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                            ...
                            <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3">
                              <div className="flex items-center gap-1 sm:gap-2 bg-slate-700 p-1">
                                <button 
                                  ...
                                  className={`w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center ${
                                    item.quantity > 1 ? 'bg-amber-600 hover:bg-amber-700 text-white' : 'bg-slate-600 text-slate-400 cursor-not-allowed'
                                  } transition-colors`}
                                >
                                ...
                                <button 
                                  ...
                                  className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center bg-amber-600 hover:bg-amber-700 text-white transition-colors"
                                >
                              ...
                              <button 
                                ...
                                className="p-1.5 sm:p-2 text-amber-400 hover:text-amber-300 hover:bg-amber-900/20 transition-colors"
                              >
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className={`flex-1 px-3 sm:px-4 py-2.5 sm:py-3 bg-slate-700 border-2 text-white placeholder-slate-400 focus:outline-none focus:ring-2 text-sm sm:text-base ${
                        couponError ? 'border-amber-500 focus:ring-amber-500' : 'border-slate-600 focus:ring-amber-500'
                      }`}
                    />
                    <button
                      onClick={() => handleApplyCoupon(subtotal)}
                      className="px-4 sm:px-6 py-2.5 sm:py-3 bg-amber-600 hover:bg-amber-700 text-white font-bold transition-colors text-sm sm:text-base whitespace-nowrap border-2 border-amber-600"
                    >
                      تطبيق
                    </button>
                  </div>
                  {couponError && <p className="text-amber-400 text-xs sm:text-sm mt-2 font-medium">{couponError}</p>}
                  ...
                  {loadingShipping ? (
                    ...
                    <div className="space-y-2">
                      {shippingMethods.map((method) => (
                        <label key={method.id} className="flex items-center gap-3 p-3 border-2 border-slate-600 cursor-pointer hover:border-amber-600">
                          <input
                            type="radio"
                            name="shipping"
                            value={method.id}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-t-2 border-slate-600 pt-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-xl font-bold text-amber-400">{formatCurrency(total, storeSettings, currencies)}</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    {paymentMethods.map((method) => (
                      <div key={method.name} className={`border-2 transition-all ${
                        selectedPayment === method.name ? 'border-amber-500 bg-slate-800' : 'border-slate-700 hover:border-slate-600'
                      }`}>
                          ...
                          <div className="px-4 pb-4 border-t border-slate-700 mt-2 pt-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 border-2 border-slate-600 rounded-lg focus:outline-none focus:border-amber-500 bg-slate-700 text-white"
                              />
                            </div>
                          </div>
                        )}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 bg-slate-700 border-2 text-white placeholder-slate-400 focus:outline-none focus:ring-2 ${
                                  whatsappError ? 'border-amber-500 focus:ring-amber-500' : 'border-slate-600 focus:ring-green-500 focus:border-green-500'
                                }`}
                              />
                              {whatsappError && (
                                <p className="mt-1 text-sm text-amber-400 font-medium">{whatsappError}</p>
                              )}
          ...
          {/* Footer */}
          <div className="border-t-2 border-amber-600 bg-black p-4 md:p-6">
            {/* Mobile Layout */}
            <div className="md:hidden">
              <div className="text-center mb-4">
                <p className="text-sm text-slate-300 font-medium">الإجمالي</p>
                <p className="text-2xl font-bold text-amber-400">{formatCurrency(total, storeSettings, currencies)}</p>
              </div>
                ...
                <div className="flex-1">
                  {step < 3 ? (
                    <button
                      ...
                      className="w-full px-6 py-3 bg-amber-600 hover:bg-amber-700 disabled:bg-slate-600 text-white font-bold transition-colors disabled:cursor-not-allowed text-sm border-2 border-amber-600"
                    >
                      متابعة
                    </button>
                  ) : (
            ...
            <div className="hidden md:flex md:items-center md:justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-sm text-slate-300 font-medium">الإجمالي</p>
                  <p className="text-xl font-bold text-amber-400">{formatCurrency(total, storeSettings, currencies)}</p>
                </div>
                ...
                {step < 3 ? (
                  <button
                    ...
                    className="px-8 py-3 bg-amber-600 hover:bg-amber-700 disabled:bg-slate-600 text-white font-bold transition-colors disabled:cursor-not-allowed border-2 border-amber-600"
                  >
                    متابعة
                  </button>
                ) : (
