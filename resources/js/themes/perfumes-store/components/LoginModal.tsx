...
const LoginModalContent: React.FC<LoginModalProps> = ({ onClose, onLoginSuccess, storeSlug }) => {
    ...
    return (
      <div className="fixed inset-0 z-50 bg-black/70" onClick={onClose}>
        <div className="flex items-center justify-center h-full p-4">
          <div 
            className="bg-slate-800 w-full max-w-md overflow-hidden shadow-2xl border-2 border-amber-600 flex flex-col max-h-[90vh]"
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  {errors.email && <p className="text-amber-400 text-sm mt-1 font-medium">{errors.email}</p>}
                </div>
                ...
                <button 
                  ...
                  } text-white border-2 border-amber-600`}
                >
                ...
                <button 
                  ...
                  type="button" 
                  className="w-full text-center text-amber-400 hover:text-amber-300 font-bold py-2"
                >
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70" onClick={onClose}>
      <div className="flex items-center justify-center h-full p-4">
        <div 
          className="bg-slate-900 w-full max-w-md overflow-hidden shadow-2xl border-2 border-amber-600 flex flex-col max-h-[90vh]"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b-2 border-amber-600 bg-black">
          ...
          <div className="flex-1 p-6 overflow-y-auto">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-300 font-medium">
                {isLogin ? 'تسجيل الدخول إلى حسابك' : 'انضم إلى مجتمع الأناقة'}
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input 
                      ...
                      required 
                      className={`w-full px-3 py-3 bg-slate-800 border-2 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 ${
              ...
              <div>
                  ...
                  <div className="relative">
                    ...
                    required 
                    className={`w-full pl-10 pr-12 py-3 bg-slate-800 border-2 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 ${
              ...
              <div className="text-center">
                ...
                <button 
                  ...
                  type="button" 
                  className="text-amber-400 hover:text-amber-300 font-bold mr-2 text-sm"
                >
