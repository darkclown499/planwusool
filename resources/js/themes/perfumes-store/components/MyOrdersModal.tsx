  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" onClick={onClose}>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-2 sm:p-4">
        <div className="bg-slate-800 w-full max-w-5xl max-h-[95vh] sm:max-h-[85vh] overflow-hidden flex flex-col border-2 border-amber-600" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-amber-400 text-xs sm:text-sm font-bold">منتجاتنا الفاخرة</div>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pr-10 pl-4 py-2 bg-slate-800 border border-slate-600 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm font-bold uppercase"
                />
              </div>
              <div className="relative min-w-[140px]">
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  <SelectTrigger className="w-fit rounded-none px-3 py-2 bg-slate-800 border border-slate-600 text-white focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm font-bold uppercase appearance-none cursor-pointer gap-3">
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 bg-slate-800">
            {loading ? (
              <div className="flex flex-col items-center justify-center py-16">
                <div className="w-12 h-12 sm:w-16 sm:h-16 border-4 border-slate-600 border-t-amber-600 animate-spin mb-4"></div>
              ...
              <div className="text-center py-16">
                ...
                <button
                  onClick={onClose}
                  className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 font-bold transition-colors text-sm sm:text-base"
                >
                  متابعة التسوق
                </button>
              </div>
              ...
              <div className="grid gap-3 sm:gap-4">
                {filteredOrders.map((order) => (
                  <div key={order.id} className="bg-slate-900 border-2 border-slate-700 hover:border-amber-600 transition-all">
                    <div className="p-3 sm:p-4">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="flex items-start gap-3 flex-1 min-w-0">
                          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-amber-600 flex items-center justify-center flex-shrink-0">
                        ...
                        <button
                          ...
                          className="bg-amber-600 hover:bg-amber-700 text-white px-3 py-2 sm:px-4 sm:py-2 font-bold transition-colors flex items-center gap-2 text-xs sm:text-sm flex-shrink-0"
                        >
