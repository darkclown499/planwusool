  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70" onClick={() => router.visit(route('store.home', { storeSlug }))}>
      <div className="flex items-center justify-center h-full p-4">
        <div 
          className="bg-slate-800 w-full max-w-md overflow-hidden shadow-2xl border-2 border-amber-600"
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b-2 border-amber-600 bg-black">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-300 font-medium">إنشاء كلمة مرور جديدة</p>
              </div>
            </div>
            <button 
          ...
          <div className="p-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    required
                    minLength={8}
                    className="w-full pr-10 pl-12 py-3 bg-slate-800 border-2 border-slate-600 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500"
              ...
              <button 
                type="submit" 
                className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-6 transition-colors flex items-center justify-center gap-2 border-2 border-amber-600"
              >
              ...
              <p className="text-center text-sm text-slate-300 font-medium">
                ...
                <button 
                  onClick={onClose}
                  type="button" 
                  className="text-amber-400 hover:text-amber-300 font-bold mr-1"
                >
                  تسجيل الدخول
                </button>
              </p>
