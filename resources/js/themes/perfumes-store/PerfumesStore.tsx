...
const PerfumesStoreContent: React.FC = () => {
  ...
  return (
    <div data-storefront="true" dir="rtl" className="min-h-screen bg-slate-50">
...
export const PerfumesStore: React.FC<PerfumesStoreProps> = (props) => {
  return (
