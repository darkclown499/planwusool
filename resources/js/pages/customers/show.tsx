...
export default function ShowCustomer() {
  ...
  const { customer, billingAddress, shippingAddress, recentOrders, auth } = usePage().props as any;
  ...
  const pageActions = [
    ...(hasPermission('edit-customers') ? [{
      ...
      onClick: () => handleActionClick('edit-customers', () => router.visit(route('customers.edit', customer.id)))
    }] : [])
  ];
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {hasPermission('manage-orders') && recentOrders && recentOrders.length > 0 && (
          <Card>
            <CardHeader>
