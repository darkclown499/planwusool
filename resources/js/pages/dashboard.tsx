                  ...
                  {dashboardData.recentOrders.length > 0 ? dashboardData.recentOrders.map((activity, index) => (
                    <div key={index} className="flex items-start gap-3 p-2 rounded-lg hover:bg-muted/50 transition-colors">
                      ...
                      <div className={`px-2 py-0.5 text-[10px] rounded-full font-medium ${
                        activity.status === 'active' || activity.status === 'approved' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' :
            ...
            <Card>
              ...
              <CardContent>
                {dashboardData.topPlans?.length > 0 ? (
                  ...
                  /* Chart Placeholder */
                  <div className="flex flex-col items-center justify-center h-48 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50/50 dark:bg-gray-800/50">
                    <BarChart3 className="h-12 w-12 text-gray-300 dark:text-gray-600 mb-3" />
                    <p className="text-sm font-medium text-gray-400 dark:text-gray-500">{t('Subscription Plans Performance')}</p>
                    <p className="text-xs text-gray-300 dark:text-gray-600 mt-1">{t('Chart will appear here once data is available')}</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
                <button
                  ...
                  className="flex items-center gap-3 p-4 rounded-xl border bg-card hover:bg-blue-50 dark:hover:bg-blue-950/20 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200 group"
                >
                  <div className="p-2.5 rounded-lg bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 group-hover:scale-110 transition-transform">
                ...
                <button
                  ...
                  className="flex items-center gap-3 p-4 rounded-xl border bg-card hover:bg-green-50 dark:hover:bg-green-950/20 hover:border-green-300 dark:hover:border-green-700 transition-all duration-200 group"
                >
                  <div className="p-2.5 rounded-lg bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400 group-hover:scale-110 transition-transform">
                ...
                <button
                  ...
                  className="flex items-center gap-3 p-4 rounded-xl border bg-card hover:bg-purple-50 dark:hover:bg-purple-950/20 hover:border-purple-300 dark:hover:border-purple-700 transition-all duration-200 group"
                >
                  <div className="p-2.5 rounded-lg bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400 group-hover:scale-110 transition-transform">
                ...
                <button
                  ...
                  className="flex items-center gap-3 p-4 rounded-xl border bg-card hover:bg-orange-50 dark:hover:bg-orange-950/20 hover:border-orange-300 dark:hover:border-orange-700 transition-all duration-200 group"
                >
                  <div className="p-2.5 rounded-lg bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400 group-hover:scale-110 transition-transform">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-3">
                {(dashboardData.metrics.pendingOrders || 0) > 0 && (
                  <div className="flex items-center gap-2 rounded-lg bg-white dark:bg-gray-900 border border-amber-200 dark:border-amber-800 px-3 py-2">
                ...
                {(dashboardData.metrics.pendingRequests || 0) > 0 && (
                  <div className="flex items-center gap-2 rounded-lg bg-white dark:bg-gray-900 border border-orange-200 dark:border-orange-800 px-3 py-2">
                ...
                {(dashboardData.metrics.pendingOrders || 0) === 0 && (dashboardData.metrics.pendingRequests || 0) === 0 && (
                  <div className="flex items-center gap-2 rounded-lg bg-white dark:bg-gray-900 border border-emerald-200 dark:border-emerald-800 px-3 py-2">
                    <div className="h-2 w-2 rounded-full bg-emerald-500" />
                    <span className="text-sm font-medium text-emerald-700 dark:text-emerald-400">{t('All orders are up to date — no pending actions')}</span>
                  </div>
                )}
              </div>
            </CardContent>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          {userHasPermission('manage-analytics') && (
            <Card>
              ...
              <CardContent>
                <div className="h-56 flex flex-col items-center justify-center border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50/50 dark:bg-gray-800/50">
                  <BarChart3 className="h-10 w-10 text-gray-300 dark:text-gray-600 mb-2" />
                  <p className="text-sm font-medium text-gray-400 dark:text-gray-500">{t('Sales chart')}</p>
                  <p className="text-xs text-gray-300 dark:text-gray-600 mt-1">{t('Chart will appear once data is available')}</p>
                </div>
              </CardContent>
            </Card>
          )}
