...
export default function CustomPagesIndex() {
 ...
 <form noValidate onSubmit={handleSubmit} className="max-h-[80vh] overflow-y-auto space-y-4">
 <div>
 <Label htmlFor="edit_title" required>Page Title</Label>
 <Input
 id="edit_title"
 value={data.title}
 ...
 <div>
 <Label htmlFor="edit_content" required>Content</Label>
 <RichTextEditor
