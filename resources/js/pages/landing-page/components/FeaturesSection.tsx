...
const DEFAULT_FEATURES = [
  {
    icon: 'store',
    title: 'طلبات واتساب منظمة',
    description: 'كل طلب يُرسل إلى واتساب برسالة معبأة بتفاصيل المنتجات والعنوان والدفع. تعمل مع كتالوجك وبوابات الدفع التي تفعلها في متجرك.',
  },
  {
    icon: 'palette',
    title: 'تصميم قابل للتخصيص',
    description: 'اختر من قوالب المتجر المتاحة وعدّل الألوان والخطوط والأقسام من لوحة التحكم لتناسب هوية متجرك.',
  },
  {
    icon: 'bar-chart',
    title: 'لوحة تحكم وتقارير',
    description: 'تابع الطلبات والمنتجات والمبيعات من مكان واحد مع تقارير وفواتير PDF.',
  },
  {
    icon: 'zap',
    title: 'متجر سريع ومتجاوب',
    description: 'صفحات خفيفة تعمل بسلاسة على الجوال والكمبيوتر مع تحسين للسرعة.',
  },
  {
    icon: 'globe',
    title: 'عربي بالكامل و RTL',
    description: 'واجهة عربية بالكامل مع اتجاه من اليمين لليسار، وإمكانية إضافة الإنجليزية أو لغات أخرى لمحتوى متجرك.',
  },
  {
    icon: 'shield',
    title: 'أمان وتشفير',
    description: 'تشفير SSL/TLS لحماية البيانات المنقولة مع نسخ احتياطي وضوابط وصول. الأمان مسؤولية مشتركة معك كصاحب متجر.',
  },
  {
    icon: 'bot',
    title: 'مساعدة بالذكاء الاصطناعي في الباقات المدعومة',
    description: 'مساعدة في كتابة أوصاف المنتجات وترجمتها في الباقات المدعومة — الإعداد والتفعيل عبر الإعدادات.',
  },
  {
    icon: 'calculator',
    title: 'التكامل المحاسبي (حسب الباقة)',
    description: 'مزامنة الفواتير والمصاريف مع نظامك المحاسبي الخارجي عبر API — متاح في الباقة الاحترافية فقط.',
  },
  {
    icon: 'truck',
    title: 'الشحن والتوصيل',
    description: 'حدد مناطق الشحن وتكاليفه، واختر التسليم اليدوي أو الربط بشركات التوصيل المدعومة (حسب توفر الخدمة في منطقتك).',
  },
];
