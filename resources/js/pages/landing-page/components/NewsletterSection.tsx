      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white rounded-xl p-8 md:p-12 border border-gray-200">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {t(sectionData?.title || 'Stay Updated with StoreGo')}
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed font-medium" id="newsletter-description">
            {t(sectionData?.subtitle || 'Get the latest e-commerce tips, StoreGo updates, and exclusive insights delivered straight to your inbox. Join our community of successful merchants.')}
          </p>
          ...
          <p className="text-gray-500 text-sm mt-4">
            {t(sectionData?.privacy_text || 'No spam, unsubscribe at any time. Your privacy is protected.')}
          </p>
              ...
              {sectionData.benefits.map((benefit, index) => (
                <div key={index} className="text-center">
                  <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <h3 className="text-gray-900 font-semibold mb-2">{t(benefit.title, { defaultValue: benefit.title })}</h3>
                    <p className="text-gray-600 text-sm">{t(benefit.description, { defaultValue: benefit.description })}</p>
                </div>
              ))}
            </div>
          )}
