  ...
  return (
    ...
    >
                ...
                <div className="glass-card flex max-w-[240px] items-center gap-2.5 rounded-2xl px-3.5 py-3">
                  <span
                    ...
                    style={{
                      ...
                      boxShadow: `0 4px 16px ${'#25D366'}60`,
                    }}
                  >
                    ...
                    <span
                      ...
                      style={{ backgroundColor: '#ef4444', boxShadow: '0 0 0 2px rgba(0,0,0,0.35)' }}
                    >
                      2
                    </span>
                  </span>
                  <div className="min-w-0">
                    <p className="text-[11px] font-bold text-white/90">رسالة جديدة</p>
                    <p className="truncate text-[11px] text-white/40">أحمد: هل نشرت منتجاتك الجديدة؟</p>
                  </div>
                  <span className="mr-auto text-[10px] font-semibold" style={{ color: brandColor }}>الآن</span>
                </div>
              </div>
      ...
      <style>{`
        ...
        .card-float-3 { animation: cardFloat3 6.5s ease-in-out 0.6s infinite; }
        .hero-star { animation: sparkleTwinkle 5s ease-in-out infinite; }
        @media (prefers-reduced-motion: reduce) {
          .card-float-1, .card-float-2, .card-float-3, .hero-star { animation: none; }
        }
      `}</style>
    </section>
  );
