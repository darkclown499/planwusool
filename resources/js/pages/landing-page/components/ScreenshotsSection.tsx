      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-8 sm:mb-12 lg:mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {t(sectionData?.title || 'See Store SaaS in Action')}
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium">
            {t(sectionData?.subtitle || 'Explore our intuitive interface and powerful features designed to streamline your digital networking experience.')}
          </p>
        </div>
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    {t(screenshot.title, { defaultValue: screenshot.title })}
                  </h3>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    {t(screenshot.description, { defaultValue: screenshot.description })}
                  </p>
                </div>
              </div>
            ))}
