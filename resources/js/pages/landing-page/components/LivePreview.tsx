...
export default function LivePreview({ data, activeSection }: LivePreviewProps) {
 ...
 <div className="text-sm font-medium text-gray-700">{t("Hero Section")}</div>
 ...
 return (
 <div className="space-y-3">
 <div className="text-sm font-medium text-gray-700">{t("Features Section")}</div>
 <div className="p-3 bg-gray-50 rounded-lg border">
 <div className="text-xs font-semibold text-gray-900 mb-1">
 ...
 return (
 <div className="space-y-3">
 <div className="text-sm font-medium text-gray-700">{t("About Section")}</div>
 <div className="p-3 bg-gray-50 rounded-lg border">
 <div className="text-xs font-semibold text-gray-900 mb-1">
 ...
 <h3 className="font-semibold text-gray-900">{t("Setup Progress")}</h3>
 </div>

 <div className="mb-4">
 <div className="flex justify-between items-center mb-2">
 <span className="text-sm text-gray-600">{t("Completion")}</span>
 ...
 <h3 className="font-semibold text-gray-900">{t("Live Preview")}</h3>
 </div>
 ...
 <h3 className="font-semibold text-gray-900">{t("Color Scheme")}</h3>
 </div>
 ...
 <h3 className="font-semibold text-gray-900">{t("Contact Info")}</h3>
 </div>

 <div className="space-y-2">
 <div className="flex items-center gap-2 text-xs">
 <Mail className="h-3 w-3 text-gray-400" />
 <span className={data.contact_email ? 'text-gray-700' : 'text-red-500'}>
 {data.contact_email || 'Email not set'}
 </span>
 </div>
 <div className="flex items-center gap-2 text-xs">
 <Phone className="h-3 w-3 text-gray-400" />
 <span className={data.contact_phone ? 'text-gray-700' : 'text-red-500'}>
 {data.contact_phone || 'Phone not set'}
 </span>
 </div>
 <div className="flex items-center gap-2 text-xs">
 <Globe className="h-3 w-3 text-gray-400" />
 <span className={data.contact_address ? 'text-gray-700' : 'text-red-500'}>
