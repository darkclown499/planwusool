...
export default function LandingPageSettings() {
 ...
 const sectionClasses = "bg-white rounded-xl border border-gray-200 p-6 shadow-sm";
 const headingClasses = "text-lg font-semibold text-gray-900";
 const subheadingClasses = "text-sm text-gray-500";
 ...
 className={activeSection === section.key ? 'text-white border-0' : ''}
 ...
 <div>
 <h3 className="text-lg font-semibold text-gray-900">{t('Company Information')}</h3>
 ...
 <Label htmlFor="company_name" className="text-sm font-medium text-gray-900 flex items-center gap-2">
