...
const FAQS = [
    {
        ...
        a: 'أبداً. المعالج الذكي يبني متجرك خطوة بخطوة، وأداة تخصيص التصميم بالسحب والإفلات تجعل التعديل أسهل من تعديل منشور على مواقع التواصل.',
    },
    {
        q: 'كيف أستلم الطلبات؟',
...
const PLANS = [
    {
        ...
        features: ['6 قوالب قطاعية (bazaar-market، grocery-souq، bakery-house، electronics-hub، fashion-atelier، restaurant-menu)', 'حتى 18 منتج · متجر واحد · 1GB', 'نطاق فرعي مجاني', 'دعم عبر البريد (8 ساعات)'],
        cta: 'ابدأ مجاناً',
        highlighted: false,
    },
    {
