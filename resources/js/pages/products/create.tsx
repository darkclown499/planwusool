              ...
              <CardContent className="space-y-4 text-start">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="grid gap-1.5">
                    ...
                    <Input id="cost_price" name="cost_price" type="number" step="0.01" value={formData.cost_price} onChange={handleChange} placeholder="0.00" aria-invalid={!!errors.cost_price} />
