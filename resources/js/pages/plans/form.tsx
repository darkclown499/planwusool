...
export default function PlanForm({ plan, hasDefaultPlan = false, otherDefaultPlanExists = false }: Props) {
  ...
  const handleRecommendedChange = (checked: boolean) => {
    setFormData(prev => ({ ...prev, is_recommended: checked }));
  };
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <form noValidate onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="grid gap-1 mb-4">
                <Label htmlFor="max_stores" required>{t("Maximum Stores")}</Label>
                <Input
                  id="max_stores"
                  name="max_stores"
                  type="number"
                  ...
                  onChange={handleChange}
                  aria-invalid={!!errors.max_stores}
                />
                <InputError message={errors.max_stores} />
              </div>
              ...
              <div>
                <Label htmlFor="max_warehouses">{t("Maximum Warehouses")}</Label>
                <Input
                  id="max_warehouses"
                  name="max_warehouses"
                  type="number"
              ...
              <div>
                <Label htmlFor="domain_type">{t("Domain Type")}</Label>
                <select
                  id="domain_type"
                  name="domain_type"
                ...
                >
                  ...
                  <option value="custom">{t("Custom Domain")}</option>
                </select>
              </div>

              <div>
                <Label htmlFor="support_hours">{t("Support Hours")}</Label>
                <Input
                  id="support_hours"
                  name="support_hours"
                  type="number"
              ...
              <div>
                <Label htmlFor="support_type">{t("Support Type")}</Label>
                <select
                  id="support_type"
                  name="support_type"
          ...
          <div className="border rounded-lg p-4 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="enable_mobile_app">{t("Mobile App")}</Label>
                <Switch
          ...
          <div className="border rounded-lg p-4 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <Label htmlFor="is_recommended">{t("Recommended")}</Label>
                  <p className="text-xs text-muted-foreground mt-1">
                    {t("Mark this plan as recommended to highlight it for customers.")}
                  </p>
                </div>
                <Switch
                  id="is_recommended"
