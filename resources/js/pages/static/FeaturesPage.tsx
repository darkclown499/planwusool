...
const allFeatures = [
  { icon: Store, title: 'متجر واتساب ذكي', desc: 'أنشئ متجرك على واتساب في دقائق مع كتالوج منتجات تفاعلي يتيح للعملاء التصفح والشراء بسهولة تامة عبر واتساب.', color: '#16a34a' },
