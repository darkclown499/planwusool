  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] xl:grid-cols-[1fr_320px] gap-8 items-start py-2">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <Label htmlFor="metaTitle" className="font-semibold text-gray-800 dark:text-gray-200">{t("Meta Title")}</Label>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <Label htmlFor="metaDescription" required className="font-semibold text-gray-800 dark:text-gray-200">{t("Meta Description")}</Label>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <Label htmlFor="metaKeywords" required className="font-semibold text-gray-800 dark:text-gray-200">{t("Meta Keywords")}</Label>
              <span className="text-sm font-medium text-gray-700 dark:text-gray-400">{keywordCount} {t("keywords")}</span>
            </div>
            <Input
              id="metaKeywords"
              type="text"
          ...
          <div className="space-y-2">
            <Label htmlFor="metaImage" required className="font-semibold text-gray-800 dark:text-gray-200">{t("Meta Image")}</Label>
        ...
        <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm h-fit space-y-4">
          <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
            <Globe className="h-5 w-5 text-emerald-600" />
            <h3 className="text-base font-bold text-gray-800 dark:text-gray-200">{t("SEO Preview")}</h3>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-3">
            ...
            <h4 className="text-[15px] text-[#1a0dab] dark:text-blue-400 font-medium leading-snug cursor-pointer hover:underline mb-1 truncate">
              {seoSettings.metaTitle || t('Your Meta Title Here')}
            </h4>
            <p className="text-xs text-[#4d5156] dark:text-gray-400 leading-snug line-clamp-2">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg overflow-hidden">
            <h5 className="text-[11px] font-medium text-gray-500 px-3 py-1 bg-slate-100/50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800 tracking-wider uppercase">
              {t("Social Media Preview")}
            </h5>
            <div className="w-full bg-slate-100 dark:bg-slate-800 aspect-[1.91/1] flex items-center justify-center relative overflow-hidden border-b border-slate-200 dark:border-slate-800">
            ...
            <div className="p-2.5 bg-[#f2f3f5] dark:bg-slate-800/80">
              <h4 className="text-sm font-semibold text-gray-900 dark:text-white leading-tight mb-0.5 truncate">
          ...
          {/* SEO Tips */}
          <div className="bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/20 rounded-lg p-3">
            <h5 className="text-xs font-semibold text-blue-900 dark:text-blue-300 flex items-center mb-1.5 uppercase tracking-wider">
              <Info className="h-3.5 w-3.5 mr-1.5" /> {t("SEO Tips")}
            </h5>
            <ul className="text-[11px] text-blue-800 dark:text-blue-400 space-y-1.5 list-none pl-0">
