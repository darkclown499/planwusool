                                            ...
                                            {heroType === 'image' && (() => {
                                                ...
                                                return (
                                                    <div className="space-y-2">
                                                        ...
                                                        <DropzoneUploader label="رفع صورة للهاتف (اختياري)" hint="900×1200 — 3:4" multiple uploading={heroUploading} onFiles={handleAddMobile} />
                                                    </div>
                                                );
                                            })()}
                                            {heroType === 'video' && (
                                                <div className="space-y-2">
                                                    ...
                                                    <DropzoneUploader label="اسحب فيديو الهاتف (اختياري)" hint="900×1200 — 3:4 — MP4" accept="video/mp4,video/*" uploading={interfaceVideoUploading} onFiles={async (files) => {
                                                        const f = Array.from(files)[0]; if (!f) return; setInterfaceVideoUploading(true);
