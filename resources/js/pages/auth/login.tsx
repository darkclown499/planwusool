        ...
        >
            <form noValidate onSubmit={submit}>
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between bg-gray-50 dark:bg-slate-700/50 border border-gray-200 dark:border-slate-600 rounded-xl px-4 py-3">
                        <label
                            htmlFor="remember"
                        ...
                        >
                            <Checkbox
                                ...
                                tabIndex={3}
                                className="w-[18px] h-[18px] rounded-lg border-2 border-gray-300 dark:border-slate-500 data-[state=checked]:border-transparent transition-all duration-200"
                                style={data.remember ? { backgroundColor: primaryColor, borderColor: primaryColor } as React.CSSProperties : {}}
                            />
                            <span className="text-sm text-gray-600 dark:text-gray-400 select-none group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors">{t("Remember me")}</span>
                        </label>
                        {canResetPassword && (
                            <TextLink
                    ...
                    <div className="mb-5">
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className="flex items-center justify-center gap-2 py-2.5 px-4 border-2 border-gray-200 dark:border-slate-600 text-sm font-semibold text-gray-700 dark:text-gray-300 rounded-xl hover:border-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition-all duration-200"
                            >
