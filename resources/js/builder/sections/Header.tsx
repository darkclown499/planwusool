      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-3 px-4">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <a href="/" className="flex min-w-0 items-center gap-2">
            ...
            <span
              className="hidden min-w-0 truncate text-lg font-extrabold tracking-tight sm:block"
        ...
        {showSearch && (
          <form onSubmit={onSearch} className="hidden max-w-md flex-1 md:block">
            <div className="relative">
              ...
              />
              <Search
                className="pointer-events-none absolute top-1/2 right-3.5 h-4 w-4 -translate-y-1/2"
          ...
          <div className="mx-auto flex max-w-7xl items-center gap-1 overflow-x-auto px-4">
            ...
            {pages.map((p) => (
              <a
                key={p.slug}
                href={`/page/${p.slug}`}
                className="px-3 py-2.5 text-sm font-medium transition hover:opacity-75"
