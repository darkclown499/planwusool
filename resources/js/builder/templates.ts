...
export const TEMPLATES: BuilderTemplateConfig[] = [
  tpl(
    ...
    [
      s('header', 1),
      s('hero', 2, { layout: 'split', hero_variant: 'split_banner' }),
      s('categories', 3, { style: 'cards', columns: 4, category_variant: 'card_pills' }),
  ...
  tpl(
    ...
    [
      ...
      s('header', 2),
      s('hero', 3, { layout: 'full', badge: 'تخفيضات الموسم', hero_variant: 'full' }),
      s('categories', 4, { style: 'chips', columns: 6, category_variant: 'icon_grid' }),
  ...
  tpl(
    ...
    [
      ...
      s('hero', 2, { layout: 'split', badge: 'مجموعة مميزة', hero_variant: 'bento_grid' }),
      s('categories', 3, { style: 'cards', columns: 4, category_variant: 'card_pills' }),
      s('products', 4, { layout: 'grid', per_page: 12, columns: 4, product_variant: 'detailed_cards_with_badges' }),
      s('banners', 5, { variant: 'carousel' }),
      s('reviews', 6),
      s('newsletter', 7),
      s('footer', 8),
    ],
  ...
  tpl(
    ...
    [
      ...
      s('header', 2),
      s('hero', 3, { layout: 'split', badge: 'أحدث الوصولات', hero_variant: 'split_banner' }),
      s('categories', 4, { style: 'cards', columns: 5, category_variant: 'image_tiles' }),
      s('products', 5, { layout: 'grid', per_page: 18, columns: 4, product_variant: 'horizontal_scroll' }),
      s('banners', 6, { variant: 'grid' }),
      s('video', 7),
      s('footer', 8),
    ],
    {
  ...
  tpl(
    ...
    [
      s('header', 1),
      s('hero', 2, { layout: 'split', badge: 'تشكيلة لهذا الموسم', title: 'أزياء تصنع الفرق', hero_variant: 'slider_full' }),
      s('categories', 3, { style: 'cards', columns: 4, category_variant: 'image_tiles' }),
      s('products', 4, { layout: 'grid', per_page: 12, columns: 4, product_variant: 'detailed_cards_with_badges' }),
      s('offers', 5),
      s('reviews', 6),
      s('footer', 7),
  ...
  tpl(
    ...
    [
      ...
      s('header', 2),
      s('hero', 3, { layout: 'full', badge: 'طازج يومياً', hero_variant: 'full' }),
      s('categories', 4, { style: 'chips', columns: 6, category_variant: 'icon_grid' }),
      s('products', 5, { layout: 'grid', per_page: 18, columns: 4, product_variant: 'compact_cards' }),
      s('banners', 6, { variant: 'carousel' }),
      s('newsletter', 7),
      s('footer', 8),
    ],
    {
  ...
  tpl(
    ...
    [
      s('header', 1),
      s('hero', 2, { layout: 'full', badge: 'جديد وحصري', title: 'أضف لمسة جريئة', hero_variant: 'bento_grid' }),
      s('categories', 3, { style: 'cards', columns: 4, category_variant: 'card_pills' }),
  ...
  tpl(
    ...
    [
      s('header', 1),
      s('hero', 2, { layout: 'split', badge: 'تشكيلة حصرية', hero_variant: 'split_banner' }),
