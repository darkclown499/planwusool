...
/* =====================================================================
 * Enrichment layer
 * Every template is normalized so it ships with a header section,
 * explicit Tailwind classes per section, per-template product columns
 * and a complete, vivid color palette. This guarantees no template
 * relies on faded default colors or renders empty white gaps.
 * ===================================================================== */
