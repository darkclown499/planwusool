...
>(({ className, htmlFor, required, children, ...props }, ref) => {
  ...
  return (
    <LabelPrimitive.Root
      ...
      data-slot="label"
      className={cn(
        "text-sm leading-none font-medium text-gray-600 select-none text-right block w-full group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50",
        className
      )}
      htmlFor={htmlFor}
      {...props}
